(function (f, k, m, d) {
    var j = "stellar", e = {scrollProperty: "scroll", positionProperty: "position", horizontalScrolling: true, verticalScrolling: true, horizontalOffset: 0, verticalOffset: 0, responsive: false, parallaxBackgrounds: true, parallaxElements: true, hideDistantElements: true, hideElement: function (p) {
        p.hide()
    }, showElement: function (p) {
        p.show()
    }}, g = {scroll: {getLeft: function (p) {
        return p.scrollLeft()
    ...
    }()), i = a("transform"), c = f("<div />", {style: "background:#fff"}).css("background-position-x") !== d, b = (c ? function (q, p, r) {
        q.css({"background-position-x": p, "background-position-y": r})
    } : function (q, p, r) {
    ...
    }), n = (k.requestAnimationFrame || k.webkitRequestAnimationFrame || k.mozRequestAnimationFrame || k.oRequestAnimationFrame || k.msRequestAnimationFrame || function (p) {
        setTimeout(p, 1000 / 60)
    });

    function o(q, p) {
        this.element = q;
        this.options = f.extend({}, e, p);
        this._defaults = e;
        this._name = j;
        this.init()
    }
    ...
    o.prototype = {init: function () {
        ...
        var p = this, q = g[p.options.scrollProperty];
        ...
        var p = this, s = g[p.options.scrollProperty], q = l[p.options.positionProperty], r = s.setLeft, t = s.setTop;
        this._setScrollLeft = (typeof r === "function" ? function (u) {
            r(p.$scrollElement, u)
        } : f.noop);
        this._setScrollTop = (typeof t === "function" ? function (u) {
            t(p.$scrollElement, u)
        } : f.noop);
        this._setPosition = q.setPosition || function (w, y, v, x, u) {
        ...
        if (p.options.responsive) {
            q.bind("load." + this.name, function () {
                p.refresh()
            })
        }
        q.bind("resize." + this.name, function () {
            p._detectViewport();
            if (p.options.responsive) {
                p.refresh()
            }
        ...
        var q = this, s = q._getScrollLeft(), p = q._getScrollTop();
        if (!r || !r.firstLoad) {
            this._reset()
        }
        ...
        if (r && r.firstLoad && /WebKit/.test(navigator.userAgent)) {
            f(k).load(function () {
                var u = q._getScrollLeft(), t = q._getScrollTop();
        ...
        var q = this.$viewportElement.offset(), p = q !== null && q !== d;
        this.viewportWidth = this.$viewportElement.width();
        this.viewportHeight = this.$viewportElement.height();
        this.viewportOffsetTop = (p ? q.top : 0);
        this.viewportOffsetLeft = (p ? q.left : 0)
    }, _findParticles: function () {
        var p = this, s = this._getScrollLeft(), r = this._getScrollTop();
        if (this.particles !== d) {
        ...
        this.$element.find("[data-stellar-ratio]").each(function (A) {
            var E = f(this), C, H, u, D, z, t, G, y, w, B = 0, F = 0, v = 0, x = 0;
            ...
            p.particles.push({$element: E, $offsetParent: G, isFixed: E.css("position") === "fixed", horizontalOffset: C, verticalOffset: H, startingPositionLeft: u, startingPositionTop: D, startingOffsetLeft: y, startingOffsetTop: w, parentOffsetLeft: B, parentOffsetTop: F, stellarRatio: (E.data("stellar-ratio") !== d ? E.data("stellar-ratio") : 1), width: E.outerWidth(true), height: E.outerHeight(true), isHidden: false})
        })
    }, _findBackgrounds: function () {
        var p = this, s = this._getScrollLeft(), r = this._getScrollTop(), q;
        this.backgrounds = [];
        ...
        q.each(function () {
            var E = f(this), u = h(E), C, H, v, D, A, t, z, x, G, B = 0, F = 0, w = 0, y = 0;
        ...
        if (typeof this.options.horizontalOffset === "function") {
            ...
            q.bind("resize.horizontal-" + this.name, function () {
        ...
        if (typeof this.options.verticalOffset === "function") {
            ...
            q.bind("resize.vertical-" + this.name, function () {
        ...
        var v = this._getScrollLeft(), s = this._getScrollTop(), A, E, z, D, q, C, w, u = true, p = true, y, B, t, r, x;
