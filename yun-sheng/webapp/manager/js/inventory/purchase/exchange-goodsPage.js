var projectId
$(function () {
    var billsType=3;   //单据类型 1:采购订单 2:采购入库单 3:采购换货单 4:采购退货单
    var tableUrl='/manager/inventory/purchase/getPurchasePageList'
    init()
    function init() {
        getCustomProject('采购换货单-单据列表')
        initTopForm()
        ...
        $.pageListCommon.initMenuBtn({
            ...
            draftDel:function(mainIds){
                $.ajaxPackage({
                    url:'/manager/IbillsMain/delCgBills/cghh_delete',
                    data:{id:mainIds},
            ...
            draftPost:function(mainIds){
				...
				function todo(){
					$.ajaxPackage({
						url:'/manager/IbillsMain/saveCheckOrder/cghh_gz',
						data:{id:mainIds},
						success:function (data) {
            ...
            red:function(postData){
                ...
                $.ajaxPackage({
                    url:"/manager/IbillsMain/saveForceFinishOrder/cghh_red",
                    data:param,
                    success:function(data){
