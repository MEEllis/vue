    ...
    function init() {
        ...
        $.pageListCommon.initMenuBtn({
            export:function(){
                ...
                functionObjExtent.construtForm('/manager/jxc/storage/allocate/documentList/exportDetail/bjdb_dc', options)
            },
            draftDel:function(mainIds){
                $.ajaxPackage({
                    url:'/manager/inventory/storage/changePrice/transfer/deleteDraftOrder',
                    data:{ids:mainIds},
            ...
            shipments:function(mainIds){
                $.ajaxPackage({
                    url:'/manager/inventory/storage/changePrice/transfer/executeDraftOrder',
            ...
            red:function(postData){
                ...
                $.ajaxPackage({
                    url:"/manager/inventory/storage/changePrice/transfer/redOfficialOrder",
                    data:param,
                    success:function(data){
