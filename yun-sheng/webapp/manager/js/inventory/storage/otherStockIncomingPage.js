...
$(function () {
    ...
    function init() {
        ...
        $.pageListCommon.initMenuBtn({
            export:function(){
                ...
                functionObjExtent.construtForm('/manager/jxc/storage/allocate/documentList/exportDetail/qtrk_dc', options)
            },
            draftDel:function(mainIds){
                $.ajaxPackage({
                    url:'/manager/inventory/storage/stock/other/incoming/deleteDraftOrder',
                    data:{ids:mainIds},
            ...
            draftPost:function(mainIds){
                $.ajaxPackage({
                    url:'/manager/inventory/storage/stock/other/incoming/executeDraftOrder',
            ...
            red:function(postData){
                ...
                $.ajaxPackage({
                    url:"/manager/inventory/storage/stock/other/incoming/redOfficialOrder",
                    data:param,
                    success:function(data){
    ...
    function initTopForm(){
        ...
        InterfaceInventory.common.getOtherOutInStorageClassVoList({
            ...
            success:function(data){
                ...
                $('#incomingType').combotree('loadData',arr)
            }
        });
        //载入 部门组件
    ...
    function getSearchParam(){
        ...
        var otherStorageClassId =$("#incomingType").combotree('getValues').toString();
        ...
        return {
            ...
            otherStorageClassId:otherStorageClassId,//入库方式
