$(document).ready(function(){
	...
	$('#issuer').modalsbox({
		grid:{
			id:'createMan',
			url: "/manager/component/employee/getCompanyEmployeeVoList",
		},
		placeholder:'发布人'
	})
...
//		查询
	...
	$('.ueSave').click(function(){
		...
		$.request({
			type: 'post',
			url: "/manager/inventory/notice/saveOrUpdateNotice/company_notice",
			data:{
				'noticeType': '1',
				'title': t,
				'content': v,
	...
	$('#delete').click(function(){
		...
		if(ids.length < 1){
			...
			$.request({
				type: 'post',
				url: "/manager/inventory/notice/deleteNotice/company_notice",
				data:{
					'noticeType': '1',
					'id': ids.join(','),
				},
