...
$(function () {
    var billsType=20;  //单据类型 18:销售订单 19:批发单 20:批发换货单 21:批发退货单
    var tableUrl='/manager/inventory/sales/getSalesPageList'
    init()
    function init() {
        getCustomProject('批发换货单-单据列表')
        initTopForm()
        ...
        $.pageListCommon.initMenuBtn({
            ...
            draftDel:function(mainIds){
                $.ajaxPackage({
                    url:'/manager/salesExchange/delete/'+mainIds,
                    data:{id:mainIds},
            ...
            draftPost:function(mainIds){
                $.ajaxPackage({
                    ...
                    url:'/manager/salesCommon/postOrInvalidBills/xshh_gz',
            ...
            red:function(postData){
                ...
                $.ajaxPackage({
                    contentType: "application/json;charset=utf-8",
                    url:"/manager/salesCommon/postOrInvalidBills/xshh_red",
