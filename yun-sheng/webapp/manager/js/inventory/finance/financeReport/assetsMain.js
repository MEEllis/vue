$(function () {
    ...
    $('.searchBtn').click(function () {
        $('#rpGrid').jqGrid('setGridParam', {
            url: '/manager/finance/getAssetsList',
            postData: {
    ...
    $('#rpGrid').jqGrid({
        ...
        colNames: ['资产', '行次', '期末余额', '年初余额','负债和所有者权益', '行次', '期末余额', '年初余额'],
        colModel: [
            ...
            {name: "periodEndBalance", width: "150px", align: "center", sortable: false},
            {name: "periodStartBalance", width: "150px", align: "center", sortable: false},
            {name: "projectName1", index: "projectName1", width: "150px", align: "center", sortable: false},
            {name: "num1", index: "num1", width: "150px", align: "center", sortable: false},
            {name: "periodEndBalance1", width: "150px", align: "center", sortable: false},
            {name: "periodStartBalance1", width: "150px", align: "center", sortable: false},
        ],
        sortable: false,
        rownumbers: true,
    ...
    $('.print').click(function () {
        ...
        $.printBills('/manager/finance/assets/print',
            {
                'accountingPeriod': $('#queryDate').val(),
                'companyIds': $('#companyIds').combotree('getValues').toString(),
                'sectionIds': $('#sectionIds').combotree('getValues').toString(),
    ...
    $('.export').click(function () {
        ...
        window.location.href="/manager/finance/assets/export?accountingPeriod="+accountingPeriod+"&companyIds="+companyIds+'&sectionIds='+sectionIds+'&assistSectionIds='+assistSectionIds+'&isContained='+isContained;
    })
