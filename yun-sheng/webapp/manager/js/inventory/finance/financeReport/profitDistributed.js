$(function () {
	...
	$('.searchBtn').click(function () {
		$('#rpGrid').jqGrid('setGridParam', {
			url: '/manager/finance/getProfitDistributedList',
			postData: {
		...
		$('#accountingPeriodBox').text($('#accountingPeriod').val())
	...
	$('.print').click(function () {
        $.printBills('/manager/finance/printProfitDistributed',
            {
                'accountingPeriod': $('#accountingPeriod').val(),
                'companyIds': $('#companyIds').combotree('getValues').toString(),
                'sectionIds': $('#sectionIds').combotree('getValues').toString(),
	...
	$('.export').click(function () {
		...
		window.location.href="/manager/finance/profitDistributed/export?accountingPeriod="+accountingPeriod+"&companyIds="+companyIds+'&sectionIds='+sectionIds+'&assistSectionIds='+assistSectionIds+'&isContained='+isContained;
	})
