$(function () {
    ...
    $('.searchBtn').click(function () {
        $('#rpGrid').jqGrid('setGridParam', {
            url: '/manager/finance/cashFlow/getFlowData',
            postData: {
    ...
    $('#rpGrid').jqGrid({
        ...
        colNames: ['项目', '行次', '本年金额', '上年金额'],
        colModel: [
            {name: "projectName", index: "projectName", width: "300px", align: "center", sortable: false},
    ...
    $('.print').click(function () {
        $.printBills('/manager/finance/cashFlow/printDetail',
            {
                'accountingPeriod': $('#queryDate').val(),
                'companyIds': $('#companyIds').combotree('getValues').toString(),
    ...
    $('.export').click(function () {
        ...
        window.location.href="/manager/finance/cashFlow/getFlowExport ?accountingPeriod="+accountingPeriod+"&companyIds="+companyIds;
    })
