			...
			for(var i=0;i<$cghs.length;i++){
				...
				for(var j=0;j<colModel.length;j++){
					...
					if(j<startIndex||j>=endIndex){
						...
						var newTh = $('<th role="columnheader" class="ui-state-default ui-th-column-header ui-th-ltr" style="height: 22px;background:transparent;border-bottom: 1px solid #DDDDDD; border-top-width: 0px; border-top-style: none; border-top-color: initial;text-align: center; "></th>');
