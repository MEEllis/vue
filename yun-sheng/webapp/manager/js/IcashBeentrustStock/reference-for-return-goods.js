...
function initGrid(){
	...
	$("#dataGrid").jqGrid({
        ...
        datatype : "json",
        colNames : [ 'ID', '入库日期', '仓库ID', '仓库名称', '商品ID','商品名称','入库数量','已结算数量', '未结算数量', '入库串号','辅助串号','入库价',
                     '入库调价后价',  '结算价', '备注',  '引入单据ID',  '引入单据ID',  '引入单据ID'],  
        colModel : [ 
                     ...
                     {name : 'nowStockNum',index : 'nowStockNum',align:'left',sortable: false,hidden: true}
                   ],
        styleUI: 'Bootstrap',
        pager : '#jqGridPager',
