...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
		...
		$("#datetimepickerStart4").datetimepicker({
			...
			var colNames = ['操作','ID','仓库名称','商品名称','现库存','数量','调拨单价','调拨总额','商品备注'];
			var JqGridColModel=[
								...
								{name:'xkcID',index:'xkcID', width:100,align:'center', sorttype:'integer',editable:true},
								{name:'number',index:'number', width:100,align:'center', sorttype:'integer',formatter:numberModel},	
								{name:'allotDan',index:'allotDan', width:100,align:'center', sorttype:'float',editable:true,formatter:"number",editoptions:{
									dataEvents:[{
										type:"blur",
										fn:function(e){
								...
								{name:'allotZong',index:'allotZong', width:100,align:'center', sorttype:'float',editable:true,formatter:"number",editoptions:{
									dataEvents:[{
										type:"blur",
										fn:function(e){
											var rex=/^[0-9]*\.{0,1}[0-9]{0,2}$/;
