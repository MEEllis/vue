...
//			    console.log(event + ',' + treeId + ',' + treeNode.tId + ", " + treeNode.name + "," + treeNode.checked);
				...
				$('.add_tree_ids').val(ids);//ids存放于此 可以通过此隐藏域获取选中项id   $('.add_tree_ids').val();
...
//						zTree.checkNode(node);
		...
		$("#datetimepickerEnd2").datetimepicker({
			...
			var JqGridColModel=[
								...
								{name:'goods_number',index:'goods_number', width:100,align:'center',formatter:numManage},
...
//				return '<span class="storName" data-toggle="modal" data-target="#storChoose" data-rId="' + options.rowId +'">' + cellvalue + '</span>';
			...
			//   0    表示串号管理     
			//   1    数量管理
			function numManage(cellvalue, options, rowObject){
//				console.log(options.rowId);
				console.log(cellvalue);
//				console.log(rowObject.numManage + '....numManage');
				var str = '';
				if(rowObject.numManage == '0'){
