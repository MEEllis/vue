function loadmodal(obj) {
	...
	function one() {
		var options = {
			...
			LoadTableUrl: "/manage/erp/fx/rebate/detail/"+$("#mid").val()+"/1",
		...
		var lock = false;
		var myobj = [];
		var colNames = ['操作', 'ID','均摊门店', '商品名称', '数量', '单台返利', '返价总额', '备注'];
		var JqGridColModel=[
							...
							{name:'num',index:'num', width:100,align:'center', sorttype:'float',formatter:"integer",editable:true},
							{name:'price',index:'price', width:100,align:'center', sorttype:'float',formatter:"number",editable:true},
							{name:'amount',index:'amount', width:100,align:'center', sorttype:'float',formatter:"number"},
	...
	function two() {
		...
		var lock = false;
		var myobj = [];
		var colNames = ['操作','ID','均摊门店','商品名称','串号','单台返利','返利总额','备注'];
		var JqGridColModel=[
							{name:'',index:'', width:70,align:'center',formatter: addAndDelete},
							{name:'id',index:'id', width:200,align:'center', sorttype:'int',hidden:true},
							{name:'sectionName',index:'sectionName', width:200,align:'center', sorttype:'string',editable:true},
