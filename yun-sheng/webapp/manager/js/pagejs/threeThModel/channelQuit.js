...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
		...
		$("#datetimepickerNo").datetimepicker({
			...
			var colNames = ['操作','ID','单据编号','退货日期','部门名称','供应商','退货员','应收金额','整单折扣','折后金额','实收金额','单据状态','关联订单','备注','制单人',
			...
			var JqGridColModel=[
								...
								{name:'deliveryXiao',index:'deliveryXiao', width:100,align:'center', sorttype:"float", formatter: "number"},
								{name:'deliveryMon',index:'deliveryMon', width:100,align:'center', sorttype:"float", formatter: "number"},
								{name:'deliveryPos',index:'deliveryPos', width:100,align:'center', sorttype:"float", formatter: "number"},
								{name:'deliveryWang',index:'deliveryWang', width:100,align:'center', sorttype:"float", formatter: "number"},
