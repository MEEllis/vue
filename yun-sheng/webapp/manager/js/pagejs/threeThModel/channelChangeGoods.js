...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
		...
		$("#datetimepickerNo").datetimepicker({
			...
			var colNames = ['操作','ID','单据编号','换货日期','部门名称','客户名称','换货员','补差金额','整单折扣','折后金额','实付金额','单据状态','备注','制单人',
			...
			var JqGridColModel=[
								...
								{name:'deliveryMark',index:'deliveryMark', width:100,align:'center', sorttype:'string'},
								{name:'deliveryMember',index:'deliveryMember', width:100,align:'center',  sorttype:'float',formatter:"number"},
								{name:'deliveryPer',index:'deliveryPer', width:100,align:'center',  sorttype:'float',formatter:"number"},
								{name:'deliveryRemark',index:'deliveryRemark', width:100,align:'center',  sorttype:'float',formatter:"number"},
								{name:'deliveryMarkingPer',index:'deliveryMarkingPer', width:100,align:'center',  sorttype:'float',formatter:"number"},
