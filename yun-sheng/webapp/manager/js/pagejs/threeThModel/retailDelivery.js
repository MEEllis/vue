...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
		...
		$("#datetimepickerNo").datetimepicker({
			...
			var colNames = ['操作','ID','单据编号','零售日期','零售门店','会员信息','营业员','销售金额','现金','POS','网付','券金额','分期余额','欠款','引入定金','单据状态','备注','制单人',
			                '制单时间','修改人','修改时间','记账人','记账时间','红冲人','红冲时间'];
			var JqGridColModel=[
								...
								{name:'deliveryXiao',index:'deliveryXiao', width:100,align:'center', sorttype:'string'},
								{name:'deliveryMon',index:'deliveryMon', width:100,align:'center', sorttype:'string'},
								{name:'deliveryPos',index:'deliveryPos', width:100,align:'center', sorttype:'string'},
								...
								{name:'deliveryQian',index:'deliveryQian', width:100,align:'center', sorttype:'string'},
								{name:'deliveryYin',index:'deliveryYin', width:100,align:'center', sorttype:'string'},
								{name:'deliveryState',index:'deliveryState', width:100,align:'center', sorttype:'string'},
