		...
		LoadTableUrl: "../../json/deposit.json", //表格数据加载接口地址
...
//		/LoadTableFomatUrl: "../../json/cw/SubjectBalance.json", //获取表格显示格式数据加载地址
		...
		TableName: "#jqGrid_retailDeposit", //显示表格名称。遵照css选择器书写
			                    ...
			                    },
			                     {
			                        ...
			                        "id": "9",
			                         "label":"预收定金"
			                            ...
			                            {
			                        "name": "writeDownDeposit",
			                        "width": "120",
			                        "index": "writeDownPayment",
			                        "formatter": "number",
			                        "align": "center",
			                        "sortable":false,
			                        "id": "9",
