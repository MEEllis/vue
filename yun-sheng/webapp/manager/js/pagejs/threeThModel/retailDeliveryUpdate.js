...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
		...
		$("#datetimepickerEnd").datetimepicker({
	      ...
	      todayButton:false    //关闭选择今天按钮
			...
			var colNames = ['操作','ID','赠品','合约机','店仓名称','商品名称','数量','含税单价','含税金额','单价','金额','折扣率','折后金额','折扣金额','税率','税额','是否分期',
			                '分期公司','分期首付','分期金额','券','备注','授权码'];
			var JqGridColModel=[
								...
								{name:'gift_flag',index:'gift_flag', width:70,align:'center', formatter: 'checkbox',formatoptions:{disabled:false}},
								{name:'cphone_flag',index:'cphone_flag', width:70,align:'center', formatter: 'checkbox',formatoptions:{disabled:false}},
								...
								{name:'installment_flag',index:'installment_flag', width:100,align:'center', formatter: 'checkbox',formatoptions:{disabled:false}},
								{name:'installment__id',index:'installment__id', width:100,align:'center',editable:true, edittype: 'select', editoptions: { value: { 1: 'One', 2: 'Two'}}},
								{name:'installment_payment',index:'installment_payment', width:100,align:'center', sorttype:'float',formatter:"number",editable:true},
								{name:'installment_balance',index:'installment_balance', width:100,align:'center', sorttype:'float',formatter:"number"},
								{name:'coupon_amount',index:'coupon_amount', width:100,align:'center', sorttype:'string',editable:true},
								{name:'remark',index:'remark', width:100,align:'center', sorttype:'string',editable:true},
								{name:'authorization_id',index:'authorization_id', width:100,align:'center', sorttype:'string',editable:true}  
			                ];
