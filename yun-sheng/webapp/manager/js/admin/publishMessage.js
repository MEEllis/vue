...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
			...
			var colNames = ['操作','ID','选项编码','选项类型','选项内容1','选项内容1','管理员工号','是否禁用','备注','新增人','新增时间','修改人','修改时间'];
			var JqGridColModel=[
								...
								{name:'areaName',index:'areaName', width:100,align:'center', sorttype:'string',sortable:false},
								{name:'fenqiName',index:'fenqiName', width:100,align:'center', sorttype:'string',sortable:false},
