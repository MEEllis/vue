		...
		pager:"#jqGridPager"
			...
			var colNames = ['ID','公司名称','设备编码','设备信息','设备身份','是否禁用','备注','新增人','新增时间','修改人','修改时间'];
			var JqGridColModel=[
								...
								{name:'deviceName',index:'deviceName', width:150,align:'center', sorttype:"string",sortable:false},
...
//							ids.shift();
			...
			$('.updateBloc').click(function(){
				...
				if(len != 1){
					...
					$('.deviceName').val(gridData.deviceName);
