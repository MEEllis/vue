...
//		inputbox: ".inputbox" //搜索条件框存放容器。遵照css选择器书写
		...
		$("#datetimepickerStart").datetimepicker({
	      ...
	      todayButton:false    //关闭选择今天按钮
			...
			var colNames = ['ID','操作人','操作时间','公司名称','部门名称','日结类型','日期','操作结果'];
			var JqGridColModel=[
								...
								{name:'storageName',index:'storageName', width:150,align:'center', sorttype:"string",sortable:false},
								{name:'storageName',index:'storageName', width:150,align:'center', sorttype:"string",sortable:false},
								{name:'depDouble',index:'depDouble', width:100,align:'center', sorttype:'string',formatter:'select', editoptions:{value:"0:失败;1:成功"},sortable:false}
			                ];
