...
function initDataGrid()
{
	...
	//['序号','科目编码', '科目名称','日期','凭证字号','摘要','单价','计量单位','数量','金额','数量','金额','方向','单价','数量','金额']
	$("#dataGrid").jqGrid({
		url: basePath + '/cw/accountsQuery/pageSubjectFdetail/'+gl_CurrCompanyId,
        datatype : "json",
        colNames : [ '序号',  '科目编码',  '科目名称',  '日期',  '凭证字号',  '摘要',  '单位',  '单价',  '数量',  '金额', '数量', '金额', '方向','数量', '余额'],
        colModel : [ 
                    ...
                    {name : 'voucherDate',index : 'voucherDate',align:'left',width:100,sortable: false}, 
                    {name : 'inNo',index : 'inNo',align:'left',width:100,sortable: false,formatter:formatterInNo}, 
                    {name : 'summary',index : 'summary',align:'left',width:250,sortable: false}, 
                    {name : 'unit',index : 'unit',align:'right',sortable: false},
                    {name : 'price',index : 'price',align:'right',sortable: false,formatter:formatterAmuont},
                    ...
                    {name : 'creditDirection',index : 'creditDirection',align:'right',formatter:formatterCreditDirection,sortable: false}, 
