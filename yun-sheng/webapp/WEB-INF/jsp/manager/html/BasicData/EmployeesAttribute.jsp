...
<script type="text/javascript">$(function() {
	var pagemodolue = new curdmodal({
		...
		GetRowInfoUrl: "../../empAttribute/ajaxGettempAtt", //获取数据详细信息接口加载地址
		GetListUrl:"../../empAttribute/listempAttJson",//获取列表数据接口
		SaveEditUrl: "../../empAttribute/saveTempAtt", //新增或修改后保存数据接口地址
	    DelRowUrl: "../../empAttribute/deleteTempAtt", // 删除信息接口地址
		SaveEditBtnName: ".savebutton", //保存按钮名称。遵照css选择器书写
		EditModalName: ".editbox" ,//新增 或者修改时弹窗名称。遵照css选择器书写
		listTempLate:'<li class="hidechild " data-id="{{id}}"><i class="iconfont"></i>{{name}}<span class="pull-right eventbox"><a class="button" data-eventname="showAddChildModal">新增员工属性</a><a class="button"  data-eventname="showEditModal">修改员工属性</a><a class="button" data-eventname="delRow">删除员工属性</a></span></li>\n',//显示列表的模板
...
buttonevent.loadingFunction(0,$(".grp_tree"));
	$.getJSON("../../json/icon.json", function(r) {
			$.each(r, function(i, item) {
				//console.log(item);
				var span = '	<span class="iconbox" data-index="'+i+'">' +
					'<i class="iconfont" >' + item + '</i></span>';
				$("#iconbox").append(span);
			});		
		});
	...
	<div class="searchbox">
		...
		<div class="grp_info">
			<div id="groupInfo">
		       ...
		       <li class="list-group-item" ><span class="txt">员工属性编码：</span><font data-col="code"> </font></li>
				<li class="list-group-item" ><span class="txt">员工属性名称：</span><font data-col="name"> </font>  </li> 
    ...
    <div class="modal-content">
     ...
     <div class="container-fluid inputbox clearfix">
         ...
         <!-- div class="row">
          ...
          <div class="col-xs-12  col-sm-12 col-md-12    col-lg-12">
			<span class="box_text">备注：</span><span class="box_input"><input type="text" name="remark" id="" value="" placeholder="请输入流程图页面页面地址" class="form-control" /></span>
                    ...
                    <div class="row">
          <div class="col-xs-12  col-sm-12 col-md-12    col-lg-12">
			<span class="box_text">功能图标：</span><span class="box_input"><input type="hidden" name="iconcode" id="iconcode"><div id="iconbox">
      ...
      <div class="row">
	     ...
	     <div class="row">
	         <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">员工属性编码：</span><span class="box_input"><input type="text" name="code" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>
	          <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">员工属性名称：</span><span class="box_input"><input type="text" name="name" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>  
	      </div>
