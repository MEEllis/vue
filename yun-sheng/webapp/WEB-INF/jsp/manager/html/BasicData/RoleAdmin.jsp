...
<script type="text/javascript">$(function() {
	var pagemodolue = new curdmodal({
		...
		GetRowInfoUrl: "../../roles/ajaxGetRole", //获取数据详细信息接口加载地址
		GetListUrl:"../../roles/listRolesJson",//获取列表数据接口
		SaveEditUrl: "../../roles/ajaxSave", //新增或修改后保存数据接口地址
	    DelRowUrl: "../../roles/deleteRoles", // 删除信息接口地址
		...
		<div class="grp_info">
			<div id="groupInfo">
				<ul class="list-group">
						...
						<li class="list-group-item" ><span class="txt">角色名称：</span><font data-col="name"> </font></li>
     ...
     <div class="container-fluid inputbox clearfix">
         ...
         <div class="row">
              ...
              <span class="box_text">是否启用：</span><span class="box_input"><select class="form-control" name="status">
			     ...
			     <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
			      <span class="box_text">是否管理员：</span><span class="box_input"><select class="form-control" name="ifAdmin" >
              	   <option value="1">是</option><option value="0">否</option></select></span>
			 </div> 
         ...
         <div class="row">
              <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">角色编码：</span><span class="box_input"><input type="text" name="code" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>
              <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
