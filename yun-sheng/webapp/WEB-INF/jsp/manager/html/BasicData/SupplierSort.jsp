...
<script type="text/javascript">$(function() {
	var pagemodolue = new curdmodal({
		...
		GetRowInfoUrl: "../../supplier/getSupplierUnitClassById", //获取数据详细信息接口加载地址
		GetListUrl:"../../supplier/list",//获取列表数据接口
		SaveEditUrl: "../../supplier/saveSupplierUnitClass", //新增或修改后保存数据接口地址
	    DelRowUrl: "../../supplier/deleteSupplierUnitClass", // 删除信息接口地址
		SaveEditBtnName: ".savebutton", //保存按钮名称。遵照css选择器书写
		EditModalName: ".editbox" ,//新增 或者修改时弹窗名称。遵照css选择器书写
		listTempLate:'<li class="hidechild " data-id="{{id}}"><i class="iconfont">&#xe60d</i>{{name}}<span class="pull-right eventbox"><a class="button" data-eventname="showAddChildModal">新增供货商类别</a><a class="button"  data-eventname="showEditModal">修改供货商类别</a><a class="button" data-eventname="delRow">删除供货商类别</a></span></li>\n',//显示列表的模板
		...
		<div class="grp_info">
			<div id="groupInfo">
		       ...
		       <li class="list-group-item" ><span class="txt">公司名称：</span><font data-col="companyName"> </font></li>
		        <li class="list-group-item" ><span class="txt">上级供货商类别名称：</span><font data-col="code"> </font></li>
		       <li class="list-group-item" ><span class="txt">供货商类别编码：</span><font data-col="code"> </font></li>
				<li class="list-group-item" ><span class="txt">供货商类别名称：</span><font data-col="name"> </font>  </li> 
  ...
  <div class="modal-dialog" style="width: 80%;">
    <div class="modal-content">
     ...
     <div class="container-fluid inputbox clearfix">
         ...
         <div class="row">
              ...
              <span class="box_text">是否启用：</span><span class="box_input"><select class="form-control" name="status">
			    ...
			    <div class="col-xs-6  col-sm-6  col-md-6    col-lg-6">
                   <span class="box_text">上级供货商类别名称：</span><span class="box_input"><select class="form-control" data-src="../json/select.json" data-default="蛤蛤">
              	   <span class="box_text">上级供货商类别名称：</span><span class="box_input"><select class="form-control"  name="groupId"></select></span>
			   </div>
	     ...
	     <div class="row">
	         <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">供货商类别编码：</span><span class="box_input"><input type="text" name="code" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>
	          <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">供货商类别名称：</span><span class="box_input"><input type="text" name="name" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>  
	      </div>
