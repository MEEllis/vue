...
<script type="text/javascript">$(function() {
	var pagemodolue = new curdmodal({
		...
		GetRowInfoUrl: "../../payattribute/getOnePayattribute", //获取数据详细信息接口加载地址
		GetListUrl:"../../payattribute/listPayattributeJson",//获取列表数据接口
		SaveEditUrl: "../../payattribute/savePayattribute", //新增或修改后保存数据接口地址
	    DelRowUrl: "../../payattribute/deletePayattribute", // 删除信息接口地址
		SaveEditBtnName: ".savebutton", //保存按钮名称。遵照css选择器书写
		EditModalName: ".editbox" ,//新增 或者修改时弹窗名称。遵照css选择器书写
		listTempLate:'<li class="hidechild " data-id="{{id}}"><i class="iconfont">&#xe60d</i>{{name}}<span class="pull-right eventbox"><a class="button" data-eventname="showAddChildModal">新增支出属性</a><a class="button"  data-eventname="showEditModal">修改支出属性</a><a class="button" data-eventname="delRow">删除支出属性</a></span></li>\n',//显示列表的模板
	...
	<div class="searchbox">
		...
		<div class="grp_info">
			<div id="groupInfo">
		       ...
		       <li class="list-group-item" ><span class="txt">支出属性编码：</span><font data-col="code"> </font></li>
				<li class="list-group-item" ><span class="txt">支出属性名称：</span><font data-col="name"> </font>  </li> 
    ...
    <div class="modal-content">
     ...
     <div class="container-fluid inputbox clearfix">
        ...
        <div class="row">
	     ...
	     <div class="row">
	         <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">支出属性编码：</span><span class="box_input"><input type="text" name="code" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>
	          <div class="col-xs-6  col-sm-6 col-md-6    col-lg-6">
                  <span class="box_text">支出属性名称：</span><span class="box_input"><input type="text" name="name" id="" value="" placeholder="请输入角色编码" class="form-control" /></span>
			  </div>  
	      </div>
