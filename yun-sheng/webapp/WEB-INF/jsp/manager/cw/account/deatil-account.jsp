...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${basePath}/css/cw/deatil-account.css" />
	...
	<body>
		...
		<script type="text/javascript" src="${basePath}/js/cw/account/deatil-account.js"></script>
	</body>
</html>	
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<ul id="myTab2" class="nav nav-tabs">
					   ...
					   <li>
					   		<a href="#tab2-2" data-toggle="tab">表头二次过滤</a>
					   </li>
					</ul>
					<div id="myTabContent" class="tab-content">
					   <div class="tab-pane fade in active" id="tab2-1">
							 ...
							 <div class="form-group">
							    ...
							    <div class="col-sm-5">
							      <select class="form-control input-sm" name="minAccountAnnual">
							         ...
							         <option selected="selected">2014.3</option>
							    ...
							    <div class="col-sm-5">
							      <select class="form-control input-sm" name="maxAccountAnnual">
							         <option>2014.1</option>
							         <option>2014.2</option>
							         <option selected="selected">2015.3</option>
							         <option>2014.4</option>
							         <option>2014.5</option>
							         <option>2014.6</option>
							         <option>2014.7</option>
					     ...
					     <div style="width: 100%;border: 0px solid #ddd;margin-top: 10px;padding: 10px;">
							 ...
							 <div class="form-group">
							    ...
							    <label class="col-sm-3 control-label"><input type="checkbox" checked="checked" name="ifFsubjectBalanceR">包含未记账</label>
							  </div>
							 <div class="form-group">
							 	<label class="col-sm-4 control-label"></label>
					   ...
					   <div class="tab-pane fade" id="tab2-2">
						 ...
						 <table class="table table-hover">
							...
							<tbody>
								<tr><td>1</td><td>科目</td><td><input type="checkbox" name="ifSubjectIdFilter" checked="checked"/></td><td>250</td></tr>
							</tbody>
						 </table>
					   </div>
					</div>
