...
<html>
				...
				<form class="well form-horizontal" role="form" id="topForm" style="padding-bottom: 0px;"> 
				  ...
				  <div class="formBtn">
					<div class="form-group">
					  ...
					  <div class="col-sm-8">
					        <input type="text" class="form-control" name="outstroDateBegin" id="outstroDateBegin">
					  </div>
					</div>
				  </div>
				  <div class="formBtn">
					<div class="form-group">
					  ...
					  <div class="col-sm-8">
					        <input type="text" class="form-control" name="outstroDateEnd" id="outstroDateEnd">
					  </div>
					</div>
				  </div>
				  <div class="formBtn">
  ...
  <script type="text/javascript" charset="utf-8" src="${basePath}/js/IcashEntrustStock/reference.js"></script>
