...
<script src="${basePath}/js/inventory/fund/supplier-rebatePage.js?v=${version}"></script>
<title>供应商返利单-单据列表</title>
</head>
<body class='e-body-bg'>
<div class="pageList">
	<!-- 菜单栏按钮组 -->
	<div class="none" id="AUTH" role="toolbar" data-code='GYSFLD'></div>
	...
	<div id="ysContainer">
		<div class="btn-toolbar" id="GridTool" role="toolbar" data-code="GYSFLD"></div>
		<div>
