...
<script src="${basePath}/js/inventory/fund/supplierRepricePage.js?v=${version}"></script>
<title>供应商保价单据列表</title>
</head>
<body class='e-body-bg pageList'>
    <!-- 菜单栏按钮组 -->
    <div class="none" id="AUTH" role="toolbar" data-code='GYSBJD'></div>
    <form action="" class="form-inline clearfix" id="searchQuery">
            ...
            <div class="col-md-3 form-group ">
                <label class="width-25">供应商:</label>
                <div class="input-group col-sm-8">
    ...
    <div id="ysContainer">
        <div class="btn-toolbar" id="GridTool" role="toolbar" data-code="GYSBJD"></div>
        <div>
