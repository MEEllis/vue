...
<script src="${basePath}/js/inventory/fund/incomeList.js?v=${version}"></script>
<title>收入单据列表</title>
</head>
<body class='e-body-bg'>
<div>
    <!-- 菜单栏按钮组 -->
    <div class="none" id="AUTH" role="toolbar" data-code='SRD'></div>
    <form  class="form-inline clearfix" id="searchQuery">
            ...
            <div class="col-md-3 form-group ">
                <label class="width-25">收入类别:</label>
                <div class="input-group col-sm-8">
    ...
    <div id="ysContainer">
        <div class="btn-toolbar" id="GridTool"  data-code="SRD" style="margin: 0 0 5px 0;"></div>
        <div>
