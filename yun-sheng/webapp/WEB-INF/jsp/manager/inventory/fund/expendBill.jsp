...
<script src="${basePath}/js/inventory/fund/expendBill.js?v=${version}"></script>
<title>费用单</title>
<style type="text/css">
    #imeiDr-modal .row {
        padding-bottom: 0;
...
<!-------------------------------------主页面开始----------------------------------------->
<div id="AUTH" class="none" data-code="FYD"></div>
...
<div >
    <div style="padding: 19px;">
        <form id="billsHeaderForm" novalidate="novalidate" class="form-inline clearfix">
            ...
            <div class="form-group col-sm-3">
                <label class="width-25"><i class="bitianX">*</i>付款部门:</label>
                <div class="input-group col-sm-8">
            ...
            <div class="form-group col-sm-3">
                <label class="width-25"><i class="bitianX">*</i>付款人:</label>
                <div class="input-group col-sm-8">
                    <input type="text" class="form-control" name="managersName" id="managerName" readonly="readonly" >
            ...
            <div class="form-group col-sm-3">
                <label class="width-25">付款金额:</label>
                <div class="input-group col-sm-8">
                    <input type="text" name="payAmountSum" id="payAmountSum" value="" class="form-control"
                           readonly="readonly"/>
                    <span class="input-group-btn showMoneyModalBtn" data-toggle="modal" data-target="#inpayMoneyModal"
                          onclick=""><button class="btn btn-default"
                                             type="button"><span
                            class="glyphicon glyphicon-option-horizontal"></span></button></span>
                </div>
            </div>
            ...
            <div class="form-group col-sm-3" id="avgType">
                <label class="width-25"><i class="bitianX">*</i>摊销方式:</label>
                <label class="input-group">
                    <input type="radio" checked name="asd" value="0">
                    一次摊销
                </label>
                <label class="input-group">
                    <input type="radio" name="asd" value="1">
                    多次平均
                </label>
            </div>

            <div class="form-group col-sm-3 monthBox" style="display: none">
                <label class="width-25"><i class="bitianX">*</i>待摊月数:</label>
                <div class="input-group col-sm-5">
                    <input type="text" name="avgMonth" id="waitMonth" value="1" style="text-align: center" class="form-control" onkeyup="checkInput.checkPositiveInteger(this,12)"/>
                </div>
                <label >个月</label>
            </div>
            ...
            <div class="form-group col-sm-12 avgMonthBox" style="display: none" >
                <div class="col-sm-3" style="padding-left: 0">
                    <label class="width-25">分摊月数:</label>
                    <div class="input-group col-sm-4">
                        <input type="hidden"  name="avgMonthDetail" id="avgMonthDetail">
                        <div id="avgMonth" style="text-align: center;color: #5184f0;cursor: pointer" ></div>
                    </div>
                    <label >个月</label>
                </div>
            </div>
...
<div class="tablebox retailDetailTable">
    ...
    <div class="grid-wrap" style="margin-top:10px">
        <div class="none">
            <input type="hidden" id="dataGridInpayType" data-desc="支出类别模态框" readonly="">
        </div>
                ...
                <div class="form-inline clearfix">
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group col-sm-8">
                                ...
                                <%--<select type="text" class="form-control" name="inpayType" id="inpayType"--%>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            ...
                            <div class="input-group col-sm-8">
                                <input type="text" class="form-control" name="waitAllotMoney" id="waitAllotMoney"
    ...
    <div class="modal-dialog" role="document" style="width: 600px;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">费用摊销 - <span class="avgBillCode"></span></h4>
            </div>
            <div class="modal-body" style="width: 600px;">
                <table id="avgGrid" class="zxsaastable"></table>
            </div>
            <div class="modal-footer">
