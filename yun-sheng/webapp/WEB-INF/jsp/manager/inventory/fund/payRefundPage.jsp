...
<script src="${basePath}/js/inventory/fund/payRefundPage.js?v=${version}"></script>
<title>预付退款单-单据列表</title>
        </head>

<body class='e-body-bg'>
<div class="pageList">
	<!-- 菜单栏按钮组 -->
	<div class="none" id="AUTH" role="toolbar" data-code='YFTKD'></div>
	<input type="hidden" value="81" name='billsType' id="billsType"/>
	<!-- 打印类型 -->
	<input type="hidden" value="81" name="printType" id="printType"/>
	...
	<div id="ysContainer">
		<div class="btn-toolbar" id="GridTool" role="toolbar" data-code="YFTKD"></div>
		<div>
