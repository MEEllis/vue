  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'default'}">
		...
		<table class="table table-bordered" style="border-color:black !important;">
			<thead>
				<tr style="padding: 0;border-color:black !important;">
					...
					<th style="font-size: 3mm;font-weight: bold;text-align: center;padding: 0;border-color:black !important;">账户类型</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;padding: 0;border-color:black !important;">调整金额</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;padding: 0;border-color:black !important;">备注</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${mainVo.detailList}" var="mainVoDetail" varStatus="status">
					<tr style="padding: 0;border-color:black !important;">
						<td style="font-size: 3mm;text-align:center;padding: 0;border-color:black !important;">${mainVoDetail.accountName}</td>
						<td style="font-size: 3mm;text-align:center;padding: 0;border-color:black !important;">${mainVoDetail.accountTypeName}</td>
						<td style="font-size: 3mm;text-align:center;padding: 0;border-color:black !important;">${mainVoDetail.amount}</td>
						<td style="font-size: 3mm;text-align:center;padding: 0;border-color:black !important;">${mainVoDetail.remark}</td>

					</tr>
				</c:forEach>	
				<tr style="padding: 0;border-color:black !important;">
					<td align="center" style="font-size: 4mm;font-weight: bold; padding: 0;border-color:black !important;"  colspan="2">合计</td>
					<td style="font-size: 3mm;font-weight: bold;text-align: center; padding: 0;border-color:black !important;">${statistics:sumByField(mainVo.detailList, 'amount')}</td>

					<td style="font-size: 3mm;font-weight: bold;text-align: right; padding: 0;border-color:black !important;"></td>
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			<div class="form-group" style="width: 47mm;float: left;">
