...
<body class='e-body-bg pageBill'>
	<input type="hidden" value="81" name='billsType' id="billsType"/>
			<div class="btn-toolbar " id="AUTH" role="toolbar"  data-code="YFTKD"  >
			</div>
			...
			<form id="billsHeaderForm" novalidate="novalidate" class="form-inline clearfix" >
				...
				<input type="hidden" name="auditStatus"/>
				 ...
				 <div class="form-group col-sm-3">
					 ...
					 <div class="input-group col-sm-8">
						 <input type="text"  class="form-control" name="yingfAmount" id="yingfAmount"   readonly="readonly" >
					 </div>
				 </div>
				 ...
				 <div class="form-group col-sm-3">
					 ...
					 <div class="input-group col-sm-8">
						 <input type="text"  class="form-control" name="yufAmount" id="yufAmount"   readonly="readonly" >
					 </div>
				 </div>
				 <div class="form-group col-sm-3">
...
<!--经手人模态框-->
<div class="modal fade" id="managerModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog model-dialog4">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true" >&times;</button>
				<h4 class="modal-title" id="">经办人选择</h4>
			</div>
