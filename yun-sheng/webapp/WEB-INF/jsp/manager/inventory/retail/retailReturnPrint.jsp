...
<jsp:include  page="../../inventoryInclude/head.jsp"/>
	<script src="${basePath}/js/inventory/retail/retailReturnPrint.js?v=${version}"></script>
...
<div class="retailContainer">
    ...
    <div class="retailContainerTop">
    		<div id="AUTH" data-code="LSKD" class="btn-group btnHundred">
                ...
                <button type="button" class="btn btn-default B_LSTHD_0020 none inlineBlock" data-toggle="modal" data-target="#printModal">打印</button>
