  ...
  <body style="padding: 10px;font-family: 微软雅黑,宋体;color: #000000;">
	...
	<c:if test="${printType == 'default'}">
		...
		<table class="table table-bordered" style="margin-bottom: 3px;" bordercolor="black">
			<thead>
				<tr style="padding: 0">
					<th style="font-size: 3mm;font-weight: bold;width: 13mm;text-align: center;border: 1px solid #000;padding: 0;">序号</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;border: 1px solid #000;padding: 0;">商品名称</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;border: 1px solid #000;padding: 0;">串号</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;border: 1px solid #000;padding: 0;">数量</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;border: 1px solid #000;padding: 0;">单价</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;border: 1px solid #000;padding: 0;">金额</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;border: 1px solid #000;padding: 0;">备注</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr style="padding: 0">
					<td align="center" style="padding: 0;font-size: 4mm;font-weight: bold;border: 1px solid #000;" colspan="3">合计</td>
		...
		<div style="font-size: 3mm;overflow: hidden;">
			<div class="" style="width: 37.5mm;float: left;">
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			...
			<div style="width: 47mm;float: left;">
		 		<label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 20mm;text-align: left;">客户签字：</label>
			</div>
	    </div>
	...
	<c:if test="${printType == 'xiaopiao'}">
		...
		<div style="padding: 10px 0;border-width: 1px 0;border-style: dashed;border-color: #999;clear: both;">
			<table class="table" style="margin-bottom: 0;" bordercolor="black">
				<thead>
					<tr style="padding: 0;">
