...
<div id="billsDIV" style="width: 268mm;position: relative;font-size: 4.5mm;">
	...
	<!-- 单据名称 -->
	<div style="text-align: center;font-size: 7mm;margin-bottom: 2mm;">
		<%--${companyName}--%>
			零售退货单
	</div>
	...
	<table class="table table-bordered" style="width:210mm;margin-bottom: 3px;font-size: 4mm; word-break: break-all;word-wrap:break-word;border-collapse: collapse;  border-spacing: 0;" bordercolor="black">
		...
		<tr style="padding: 0;">
			...
			<th style="padding: 0;font-weight: bold;text-align: center;border: 1px solid #000;">退货单价</th>
			<th style="padding: 0;font-weight: bold;text-align: center;border: 1px solid #000;">退款金额</th>
	...
	<div id="formBottom" style="">
		...
		<div  style="width: 64mm;float: left;">
			<label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 30mm;text-align: left;">客户签字：</label>__________
		</div>
	</div>
