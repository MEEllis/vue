...
<jsp:include  page="../../inventoryInclude/head.jsp"/>
	<script src="${basePath}/js/inventory/retail/retailBillPrint2.js?v=${version}"></script>
...
<div class="retailContainer">
    ...
    <div class="retailContainerTop">
    		<div id="AUTH" data-code="LSKD" class="btn-group btnHundred">
                <button type="button" class="btn btn-default navbar-btn inlineBlock" id="newBills">新开单</button>
                <button type="button" class="btn btn-default navbar-btn inlineBlock" data-toggle="modal" data-target="#printModal">打印</button>
                <button type="button" class="btn btn-default navbar-btn inlineBlock" id="saveModify">保存修改</button>
                <button type="button" class="btn btn-default navbar-btn inlineBlock hisbill" style="float:right;">历史单据</button>
            </div>
        <div class="retailNav">
