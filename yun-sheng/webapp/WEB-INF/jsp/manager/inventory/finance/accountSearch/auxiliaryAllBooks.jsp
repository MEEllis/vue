...
<script src="${basePath}/js/inventory/finance/accountSearch/auxiliaryAllBooks.js?v=${version}"></script>
<title>辅助总账</title>
</head>
<body>
<header>
    <div id="AUTH" data-code="FZZZ" class="btnbox clearfix btn-group none">
    </div>
