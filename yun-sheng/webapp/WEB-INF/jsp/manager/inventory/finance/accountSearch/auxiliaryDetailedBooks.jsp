...
<script src="${basePath}/js/inventory/finance/accountSearch/auxiliaryDetailedBooks.js?v=${version}"></script>
<title>辅助明细账</title>
</head>
<body>
<header>
    <div id="AUTH" data-code="FZMXZ" class="btnbox clearfix btn-group none">
    </div>
