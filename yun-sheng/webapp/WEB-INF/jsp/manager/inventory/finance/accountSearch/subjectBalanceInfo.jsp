...
<script src="${basePath}/js/inventory/finance/accountSearch/subjectBalanceInfo.js?v=${version}"></script>
<title>科目余额表</title>
</head>
<body>
<header>
    <div id="AUTH" data-code="KMYE" class="btnbox clearfix btn-group none">
    </div>
...
<div id="rpContainer">
    ...
    <div class='gridTitle'>发生额及余额表</div>
	</div>
