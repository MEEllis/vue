...
<script src="${basePath}/js/inventory/finance/accountSearch/subjectAllBooks.js?v=${version}"></script>
<title>科目总账</title>
</head>
<body>
<header>
    <div id="AUTH" data-code="KMZZ" class="btnbox clearfix btn-group none">
    </div>
...
<div id="rpContainer">
	<div id="rpContainerTop">
	    <div class="funBtnBox">
        <button type="button" class="btn btn-default mr15 export "><span class="iconBox exportIconBox" style="background:url('${basePath}/images/inventory/common/export_icon.png') no-repeat center center;background-size:contain;"></span>导出</button>
