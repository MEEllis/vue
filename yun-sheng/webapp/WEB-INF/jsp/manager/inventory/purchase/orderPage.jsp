...
<script src="${basePath}/js/inventory/purchase/orderPage.js?v=${version}"></script>
<title>采购订单-单据列表</title>
</head>
<body class='e-body-bg'>
<div class="pageList">
    <!-- 菜单栏按钮组 -->
    <div class="none" id="AUTH" role="toolbar" data-code='CGDD'></div>
    <form action="" class="form-inline clearfix" id="searchQuery">
            ...
            <div class="form-group col-sm-3 fr">
                ...
                <div class="explainBox">
                    1）可查询“未审核、已审核、入库中、已完成、强制完成”采购订单单据<br/>
                    2）可对“未审核”采购订单单据进行“审核、删除”操作<br/>
                    3）可对“已审核、入库中”的采购订单进行“强制完成”<br/>
                    4）“已审核、入库中”的采购订单“稽核”后不能做“强制完成”需“取消稽核”<br/>
    ...
    <div id="ysContainer">
        <div class="btn-toolbar" id="GridTool" role="toolbar" data-code="CGDD"></div>
        <div>
