...
<script src="${basePath}/js/inventory/purchase/returned-goodsPage.js?v=${version}"></script>
<title>采购退货单-单据列表</title>
</head>
<body class='e-body-bg'>
<div class="pageList">
    <!-- 菜单栏按钮组 -->
    <div class="none" id="AUTH" role="toolbar" data-code='CGTHD'></div>
    ...
    <form action="" class="form-inline clearfix" id="searchQuery">
            ...
            <div class="form-group col-sm-3 fr">
                ...
                <div class="explainBox">
                    1）可查询“草稿单、已过账、已红冲”的采购退货单单据<br/>
                    2）可对“草稿单”的采购退货单单据进行“过账、删除”操作<br/>
                    3）可对“已过账”的采购退货单进行“红冲”<br/>
                    4）“已过账”的采购退货单“稽核”后不能做“红冲”需“取消稽核”<br/>
    ...
    <div id="ysContainer">
        <div class="btn-toolbar" id="GridTool" role="toolbar" data-code="CGTHD"></div>
        <div>
