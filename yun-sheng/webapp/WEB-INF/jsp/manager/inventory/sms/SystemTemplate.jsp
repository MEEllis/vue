...
<title>系统短信模板</title>
<script src="${basePath}/js/inventory/sms/SystemTemplate.js?v=${version}"></script>
    ...
    <div class="btn-toolbar"  role="toolbar">
        <div class="btn-group-left">
            <button type="button" data-key="add" class="btn e-btn e-btn-left" onclick="modalUpdate(1)">
                <span class="iconfont icon-xinzeng"></span>新增模板
            </button>
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4" >
                    ...
                    <div class="input-group" style="width:80%">
                        <input type="text" id="queryText" name="queryText" class="form-control2"  placeholder="按模板标题、模板内容、备注查询"  />
                    </div></div>
                </div>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="input-group col-sm-8">
                                            <div class="radio col-sm-4">
                                                <label>
                                                    <input type="radio" name="ifTouch" id="ifTouch1" value="" style="position:absolute;top:-3px" checked>
                                                    是
                                                </label>
                                            </div>
                                            <div class="radio  col-sm-4">
                                                <label>
                                                    <input type="radio" name="ifTouch" id="ifTouch2" value="" style="position:absolute;top:-3px">
                                                    否
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group cf none">
                                        ...
                                        <div class="input-group col-sm-8" >
                                            <div class="radio col-sm-4">
                                                <label>
                                                    <input type="radio" name="touchType" id="touchType1" style="position:absolute;top:-3px" value="" checked>
                                                    业务触发
                                                </label>
                                            </div>
                                            <div class="radio  col-sm-4">
                                                <label>
                                                    <input type="radio" name="touchType" id="touchType2" value="" style="position:absolute;top:-3px">
                                                    定时触发
                                                </label>
                                            </div>
                                        </div>
