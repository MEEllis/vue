	...
	<div id="billsDIV" style="width: 190mm;position: relative;">
		...
		<table class="table table-bordered"  style="word-break: break-all; word-wrap:break-word;" border-color="black">
			...
			<tbody>
				...
				<c:forEach items="${order.detailList}" var="detail" varStatus="status">
					...
					<!-- 串号列表不为空，则输出 -->
					<c:if test="${detail.detailList != null && fn:length(detail.detailList) > 0}">
					<tr style="padding: 0;">
						<td colspan="7" style="font-size: 3mm;text-align:left;height: auto; padding:0;">
							<c:forEach items="${detail.detailList}" var="detailImei">
							${detailImei.imei},
							</c:forEach>
						</td>
					</tr>
				...
				<tr style="padding: 0;">
					...
					<td colspan="2" align="center" style="font-size: 3mm; padding:0;"><fmt:formatNumber type="number" maxFractionDigits="2" value="${sumPri}"/></td>
				</tr>
			</tbody>
		</table>
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			...
			<div class="form-group" style="width: 40mm;float: left;">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;width: 19mm;">
