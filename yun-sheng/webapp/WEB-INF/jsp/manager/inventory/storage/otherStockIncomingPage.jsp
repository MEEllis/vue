...
<script src="${basePath}/js/inventory/storage/otherStockIncomingPage.js?v=${version}"></script>
<title>其他入库单-单据列表</title>
</head>
<body class='e-body-bg'>
<div class="pageList">
    <!-- 菜单栏按钮组 -->
    <div class="none" id="AUTH" role="toolbar" data-code='QTRKD'></div>
    ...
    <div class="well clearfix">
        <form action="" class="form-inline" id="searchQuery">
            ...
            <div class="col-md-3 form-group">
                <label class="width-25">入库方式:</label>
                <div class="input-group col-sm-8">
                    <input type="text" id="incomingType" name="incomingType" class="form-control easyui-combotree" data-options="multiple:'true'" style="height: 34px;">
                </div>
            </div>
            ...
            <div class="form-group col-sm-3 fr">
                ...
                <div class="explainBox">
                    1）可查询“草稿单、已过账、已红冲”的其他入库单单据<br/>
                    2）可对“草稿单”的其他入库单单据进行“过账、删除”操作<br/>
                    3）可对“已过账”的其他入库单进行“红冲”<br/>
                    4）“已过账”的其他入库单“稽核”后不能做“红冲”，需“取消稽核”<br/>
        ...
        <div id="ysContainer">
            <div class="btn-toolbar" id="GridTool" role="toolbar" data-code="QTRKD"></div>
            <div>
