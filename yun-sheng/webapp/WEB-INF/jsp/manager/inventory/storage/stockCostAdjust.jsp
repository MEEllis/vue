...
<script src="${basePath}/js/inventory/storage/stockCostAdjust.js?v=${version}"></script>
<title>库存成本调整单</title>
<style type="text/css">
    #imeiDr-modal .row{
        padding-bottom: 0;
    ...
    <div class="well clearfix">
        <form id="billsHeaderForm" novalidate="novalidate" class="form-inline">
            ...
            <div class="form-group col-sm-3">
                ...
                <div class="input-group col-sm-8">
                    <select class="form-control" id="adjustmentType">
                        <option value="1">财务成本</option>
                        <option value="2">公司成本</option>
                        <option value="5">财务成本+公司成本</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group col-sm-3">
             ...
             <div class="form-group col-sm-3">
                 <label for="averagPrice">
                     <input type="checkbox" name='averagPrice' id="averagPrice" />开启一键均价
                 </label>
             </div>
