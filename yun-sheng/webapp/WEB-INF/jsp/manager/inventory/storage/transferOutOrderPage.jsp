...
<script src="${basePath}/js/inventory/storage/transferOutOrderPage.js?v=${version}"></script>
<title> 同价调拨发货单单据列表</title>
</head>
<body class='e-body-bg'>
<div class="pageList">
    <!-- 菜单栏按钮组 -->
    <div class="none" id="AUTH" role="toolbar" data-code='TJDBFHD'></div>
    ...
    <div id="ysContainer">
        <div class="btn-toolbar" id="GridTool" role="toolbar" data-code="TJDBFHD"></div>
        <div>
