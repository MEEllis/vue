...
<script src="${basePath}/js/inventory/storage/storageCom.js?v=${version}"></script>
	<script src="${basePath}/js/inventory/storage/changePriceTransfer.js?v=${version}"></script>
	<link rel="stylesheet" href="${basePath}/css/inventory/storage/changePriceTransfer.css?v=${version}"/>
    <title>变价调拨发货单</title>
    <style type="text/css">
...
<div >
    <div class="btn-toolbar" id="MenuTool" role="toolbar" data-code="BJDBFHD"></div>
	<div id="AUTH" data-code="BJDBFHD" class="none btn-group btnHundred" role="group" >
		  ...
		  <div class="btn-group">
			  ...
			  <ul class="dropdown-menu">
			  	<li><a class='printOpt' data-isPrice="true" data-type='numberDetail' href="javascript:void(0)">商品汇总（显示价格）</a></li>
			  	<li><a class='printOpt' data-isPrice="true" data-type='imeiDetail' href="javascript:void(0)">商品明细（显示价格）</a></li>
				<li><a class='printOpt' data-isPrice="false" data-type='numberDetail' href="javascript:void(0)">商品汇总（不显示价格）</a></li>
				<li><a class='printOpt' data-isPrice="false" data-type='imeiDetail' href="javascript:void(0)">商品明细（不显示价格）</a></li>
			  </ul>
		  </div>
		...
		<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
				onclick="window.parent.openWorkBoxByMenutext('变价调拨发货单单据列表',  '/manager/jxc/storage/allocate/documentList/samePricetransfer/historicaDoc?TypeName=2', true)">历史单据</button>
