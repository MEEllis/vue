...
<jsp:include  page="../../inventoryInclude/head.jsp"/>
	...
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/inventory/home/companyMain.js?v=${version}"></script>
	<style type="text/css">
 ...
 <body>
    <!-------------------------------------主页面开始----------------------------------------->
    <div class="head">
    	<div id="AUTH" data-code="GSGG" class="btn-group none">
...
<!--            <button type="button" class="btn" id="delete">删除</button>-->
        ...
        <div class="form-inline headbox">
            <div class="form-group col-sm-3">
                <label class="width-25">发布人：</label>
                   	<div class="input-group col-sm-8">
                   	<input type="text" class="form-control" id="issuer" placeholder="请选择发布人" />
                </div>
            </div>
            <div class="form-group col-sm-3">
