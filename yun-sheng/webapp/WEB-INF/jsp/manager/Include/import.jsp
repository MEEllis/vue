	...
	<link rel="stylesheet" type="text/css" href="${basePath}/js/cw/bootstrap/css/bootstrap-datepicker3.css?v=${version}"/>
	<link rel="stylesheet" type="text/css" href="${basePath}/js/cw/bootstrap/css/bootstrap-select.min.css?v=${version}">
	<link rel="stylesheet" type="text/css" href="${basePath}/js/cw/bootstrap/css/bootstrap-switch.css?v=${version}">
	...
	<link rel="stylesheet" type="text/css" href="${basePath}/css/market/public2.css?v=${version}" />
	
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/jquery-1.12.4.min.js?v=${version}" ></script>
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/base.js?v=${version}"></script>
	...
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/cw/jquery.ztree.all-3.5.min.js?v=${version}"></script>
	...
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/bootstrapValidator.js?v=${version}"></script>
	...
	<script type="text/javascript" charset="utf-8" src="${basePath}/html/muti_select/MultiSelectDropList.js?v=${version}" ></script>
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/select2.full.js?v=${version}" ></script>
	<script type="text/javascript" charset="utf-8" src="${basePath}/js/jquery.datetimepicker.full.js?v=${version}" ></script>
