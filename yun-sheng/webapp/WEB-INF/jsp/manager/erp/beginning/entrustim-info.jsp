...
<html>
  ...
  .ui-jqgrid .ui-jqgrid-bdiv {
	...
	<body>
		...
		<!--委托库存主页开始   -->
		    <div class="content1">
		     <div class="gridTop">
			<!--top -->
			<div id="AUTH" data-code="WTWJDR" class="btn-group btnHundred btn-grp" role="group" >
				...
				<button type="button" class=" btn btn-default"><a href="${basePath}/qichu/委托未结导入模板.xls" data-eventname="execute">模板下载</a></button>
				<button type="button" class=" btn btn-default"><a href="${basePath}/beginning/entrustim/export/2" data-eventname="execute">导出</a></button>
				...
				<!-- 
				  ...
				  <a  class="bn" href="${basePath}/qichu/委托导入模板.xls" data-eventname="execute">模板下载</a>
				  <a  class="bn" href="${basePath}/beginning/entrustim/export/2" data-eventname="execute">导出</a>
	...
	<script src="${basePath}/js/begin_period/entrustim-info.js?v=${version}" type="text/javascript" charset="utf-8"></script>
	<!-- 验证 -->
