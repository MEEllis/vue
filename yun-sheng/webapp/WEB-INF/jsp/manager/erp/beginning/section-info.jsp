 ...
 <body>
		...
		<!--仓库主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a  class="bn" data-eventname="execute" href="${basePath}/qichu/部门导入模板.xls">模板下载</a>
			  <a  class="bn lead_into"  data-eventname="lead_into" data-toggle="modal" data-target="#into" >导入</a>
			  <a  class="bn" data-eventname="execute" href="${basePath}/beginning/section/export">导出</a>
	...
	<script src="${basePath}/js/begin_period/section_info.js?v=${version}" type="text/javascript" charset="utf-8"></script>
