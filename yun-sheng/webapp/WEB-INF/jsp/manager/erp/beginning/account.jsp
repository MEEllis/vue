...
<html>
  ...
  <body>
    <div class="content">
		<!--资料账户导入主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a href="${basePath}/qichu/资金账户导入模板.xls"  class="bn">模板下载</a>
			  <a class="bn lead_into"  data-eventname="lead_into" data-toggle="modal" data-target="#into" >导入</a>
			  <a href="${basePath}/beginning/account/export"  class="bn">导出</a>	
			...
			<div class="tablebox retailDetailTable">
				<div class="grid-wrap" >
					<table id="jqGrid_account" class="zxsaastable"></table>
				    <div id="jqGridPagerAccount" style="height:42px"></div>
				</div>
			</div></div>
			<!--表格   end-->
			</div>
			...
			<div class="modal-dialog modalNine">
				<div class="modal-content " style=" width: 883px;">
				  ...
				  <div class="modal-body">
				     <p><span>上传文件:</span><input type="text" name="" id="" value="" class="des_file"/>
	...
	<script src="${basePath}/js/begin_period/account.js?v=${version}" type="text/javascript" charset="utf-8"></script>
