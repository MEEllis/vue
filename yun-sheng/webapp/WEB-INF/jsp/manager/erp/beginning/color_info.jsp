 ...
 <body>
		...
		<!--颜色资料主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a  class="bn" data-eventname="execute" href="${basePath}/qichu/颜色导入模板.xls">模板下载</a>
			  <a  class="bn lead_into"  data-eventname="lead_into" data-toggle="modal" data-target="#into" >导入</a>
			  <a  class="bn" data-eventname="execute" href="${basePath}/beginning/goodsbrand/export/2">导出</a>
			...
			<div class="tablebox retailDetailTable">
				<div class="grid-wrap" >
					<table id="jqGrid_colorInfo" class="zxsaastable"></table>
				    <div id="jqGridPagerColorInfo" style="height:42px"></div>
				</div>
			</div></div>
			<!--表格   end-->
			</div>
	...
	<script src="${basePath}/js/begin_period/color_info.js?v=${version}" type="text/javascript" charset="utf-8"></script>
