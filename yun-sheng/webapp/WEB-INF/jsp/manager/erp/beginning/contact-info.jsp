...
<html>
  ...
  <body>
   	<div class="content">
		<!--往来单位主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a href="${basePath}/qichu/往来单位导入模板.xls" class="bn">模板下载</a>
			  <a class="bn lead_into"  data-eventname="lead_into" data-toggle="modal" data-target="#into" >导入</a>
			  <a href="${basePath}/beginning/contactUnit/export" class="bn save">导出</a>	
			  ...
			  <a  class="bn" data-eventname="">往来单位查询</a>
			  <!--<a  class="bn" href="${basePath}/authority/contactInfo/toContact">返回</a>
			--></div>
			<!--top end-->
			<!--快速搜索-->
   ...
   <jsp:include page="import_beginning.jsp"></jsp:include>
	<script src="${basePath}/js/begin_period/contact-info.js?v=${version}" type="text/javascript" charset="utf-8"></script>
	<!-- 验证 -->
