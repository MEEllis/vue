...
<html>
  ...
  <body>
    <div class="content">
		<!--资料账户导入主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a href="${basePath}/qichu/辅助余额导入模板.xls"  class="bn">模板下载</a>
	...
	<script src="${basePath}/js/begin_period/auxiliaryBeginning.js?v=${version}" type="text/javascript" charset="utf-8"></script>
