  ...
  <body>
		...
		<!--商品档案主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a  class="bn" data-eventname="execute" href="${basePath}/qichu/商品名称导入模板.xls">模板下载</a>
			  <a  class="bn goods_lead"  data-eventname="goods_lead" data-toggle="modal" data-target="#into" >导入</a>
			  <a  class="bn" data-eventname="execute" href="${basePath}/beginning/goodsname/export/1">导出</a>
			...
			<div class="search_info">
				<p ><span style="margin-right: 10px;">快速搜索:</span><input type="text" placeholder="编码、名称、助记码模糊匹配" class="ipt_text srch"/><a class="search_maybe">查询</a></p>
			</div>
			<!--表格 -->
			<div class="tble">
			<div class="tablebox retailDetailTable">
				<div class="grid-wrap" >
					<table id="jqGrid_goodRecoder" class="zxsaastable"></table>
				    <div id="jqGridPagergoodRecoder" style="height:42px"></div>
				</div>
			</div></div>
			<!--表格   end-->
			</div>
			...
			<div class="modal-dialog modalNine">
				<div class="modal-content " style=" width: 883px;">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="leadgoodModalLabel">
							商品导入
						</h4>
					</div>
				  <div class="modal-body">
					...
					<div class="modal-footer">
						<a href="#" class="btn btn-w btn-info lead_model" title="" data-dismiss="modal" >商品导入</a>
						<button type="button" class="btn btn-warning" data-dismiss="modal">取消</button>
					</div>
					
				</div><!-- /.modal-content -->
			</div><!-- /.modal -->
		</div><!-- 商品导入模态框（Modal）结束 -->
	</body>
	<jsp:include page="import_beginning.jsp"></jsp:include>
	<script src="${basePath}/js/begin_period/goodsname_info.js?v=${version}" type="text/javascript" charset="utf-8"></script>
	<!-- 验证 -->
