 ...
 <body>
		...
		<!--商品类别主页开始   -->
			...
			<div class="btn-grp" role="group" >
			  <a  class="bn" href="${basePath}/qichu/商品类别导入模板.xls">模板下载</a>
			  <a  class="bn lead_into"  data-eventname="lead_into" data-toggle="modal" data-target="#into" >导入</a>
			  <a  class="bn"  href="${basePath}/beginning/goodsbrand/export/3">导出</a>
	...
	<script src="${basePath}/js/begin_period/goodsSort_info.js?v=${version}" type="text/javascript" charset="utf-8"></script>
