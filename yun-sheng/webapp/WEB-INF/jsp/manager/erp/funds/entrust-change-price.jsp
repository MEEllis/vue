...
<html>
  ...
  <body>
	    ...
	    <div class=" gridTools">
	        <div class="col-md-12">
				<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="WTSPTJD" class="btn-group btnHundred">
			        ...
			        <button type="button" class="btn btn-default navbar-btn forceFinish hide" onclick="forceFinishBtClick()">红冲</button> -->
				...
				<form class="well form-horizontal" role="form" id="topForm"> 
				  ...
				  <div class="formBtn">
					<div class="form-group">
					    ...
					    <div class="col-sm-8">
		                <div class="input-group">
							<input type="text" class="form-control" name="billsDate" readonly="readonly" placeholder="年-月-日">
					    </div></div>
					</div>
				  </div>
				  <div class="formBtn">
				  ...
				  <div class="formBtn">
					<div class="form-group">
					  <label class="col-sm-3 control-label">应收余额:</label>
					  <div class="col-sm-8">
		                <div class="input-group">
					    <input type="text" class="form-control" id="yingShou" value="0" disabled="disabled">
					  </div></div>
					</div>
				  </div>
				  <div class="formBtn">
					<div class="form-group">
					  <label class="col-sm-3 control-label">预收余额:</label>
					  <div class="col-sm-8">
		                <div class="input-group">
					    <input type="text" class="form-control" id="yuShou" value="0" disabled="disabled">
					  </div></div>
					</div>
				  </div>
				  <div class="formBtn">
	        		...
	        		<div class="row">
	        			<div class="col-md-3">
			        		<div class="form-horizontal" role="form" style="margin-top: 5px;"> 
								<div class="form-group">
								  <label class="col-sm-4 control-label">调价串号:</label>
	        			...
	        			<div class="col-md-3">
			        		<button type="button" class="btn btn-default" onclick="selectBeentrustStockReferenceOpen()">引用委托未结算数据</button>
						</div>
					</div>
					<!-- /S 表体 -->
	    ...
	    <div class="row gridBottom">
	        <div class="col-sm-12">
				...
				<form class="form-horizontal" role="form" id="bottomForm"> 
				  ...
				  <!-- 
				  <div >
					<div class="form-group footerInfo">
					  <label class="col-sm-5 control-label">红冲人:</label>
					  <div class="col-sm-7">
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/entrust-change-price.js?v=${version}"></script>
...
<div class="modal fade" id="beentrustStockReferenceModal" tabindex="-1" role="dialog"  aria-hidden="true">
   <div class="modal-dialog" style="width:930px;">
      <div class="modal-content">
         <div class="modal-body">
			<iframe name="beentrustStockReferenceFrame" class="referenceFrame" id="beentrustStockReferenceFrame" frameborder="0" style="width: 100%;" src="${basePath}/IcashEntrustStock/reference"></iframe>
         </div>
	  </div>
	</div>
</div>
