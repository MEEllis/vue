...
<html>
  ...
  <body>
	    ...
	    <div class=" gridTools">
	        <div class="col-md-12">
				<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="STSPTJD" class="btn-group btnHundred">
			        		...
			        		<div class="form-horizontal" role="form" style="margin-top: 5px;"> 
								<div class="form-group">
								  ...
								  <div class="col-sm-8 wiRes">
								    ...
								    <input type="text" class="form-control searchImei" onkeyup='checkInput.clearNoNum(this,20);' placeholder="串号输入,可右匹配" >
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/be-entrust-change-price.js?v=${version}"></script>
...
<div class="modal fade" id="beentrustStockReferenceModal" tabindex="-1" role="dialog"  aria-hidden="true">
   <div class="modal-dialog" style="width:930px;">
      <div class="modal-content">
         <div class="modal-body">
			<iframe name="beentrustStockReferenceFrame" class="referenceFrame" id="beentrustStockReferenceFrame" frameborder="0" style="width: 100%;" src="${basePath}/IcashBeentrustStock/reference"></iframe>
         </div>
	  </div>
	</div>
</div>
