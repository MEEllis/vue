...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		var billId = $.trim(functionObjExtent.getQueryString("billsId"));
		//基本目录
  ...
  <div class="btn-toolbar " id="MenuTool"  data-code="KHJBD"  >
  </div>
	<div >

 		<div id="AUTH" data-code="KHJBD" class="none btn-group btnHundred">
					...
					<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
							onclick="window.parent.openWorkBoxByMenutext('客户价保单-单据列表',  '/manager/inventory/fund/historyMain?billsType=33', true)">历史单据</button>

				</div>
		<div class="pageBillForm gridTop" >
			<form id="topForm" class="form-inline clearfix">
				...
				<div class="form-group col-sm-3">
					<label  class="width-25">保价类型:</label>
					<div class="input-group col-sm-8">
						<select class="form-control" id="subTypeSelect" name="subType">
							<option value="1" selected="selected">串号</option>
	    ...
	    <div class="row gridBody" style="padding-top: 0px;">
	        <div class="col-md-12">
					<ul class="nav nav-tabs" style="display: none;" id="subTypeTabs">
					   <li class="active">
					   		<a href="#tab1-1" data-toggle="tab">串号价保</a>
					   </li>
					   <li>
					   		<a href="#tab1-2" data-toggle="tab">数量价保</a>
					   </li>
					</ul>
  ...
  <script type="text/javascript" src="${basePath}/js/erp/funds/th3common.js?v=${version}"></script>
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/client-reprice.js?v=${version}"></script>
        	...
        	<div class="form-horizontal" role="form"> 
				...
				<div class="form-group col-sm-10">
				  ...
				  <div class="col-sm-8 wiRes">
				    <input type="text" class="form-control searchImei" value="" /><!-- onkeyup='checkInput.clearNoNum(this,0,20);'  -->
