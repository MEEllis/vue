...
<html>
  ...
  <body>
	    ...
	    <div class=" gridTools">
	        <div class="col-md-12">
				<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="WTCJD" class="btn-group btnHundred">
			        ...
			        <button type="button" class="btn btn-default navbar-btn" onclick="test()" style="display: none;">测试</button>
	        		...
	        		<div class="row">
	        			<div class="col-md-3">
			        		<div class="form-horizontal" role="form" style="margin-top: 5px;"> 
								<div class="form-group">
								  <label class="col-sm-4 control-label">撤结串号:</label>
	        			...
	        			<div class="col-md-3">
			        		<button type="button" class="btn btn-default" onclick="selectBeentrustStockReferenceOpen()">引用委托已结算数据</button>
						</div>
					</div>
					<!-- /S 表体 -->
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/entrust-undo-settlement.js?v=${version}"></script>
