...
<html>
  ...
  <body>
	    ...
	    <div class=" gridTools">
	        <div class="col-md-12">
				<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="STCJD" class="btn-group btnHundred">
	    ...
	    <div class="row gridBody" style="padding-top: 0px;">
	        <div class="col-md-12">
	        		<div class="row">
	        			...
	        			<div class="col-md-3">
			        		<button type="button" class="btn btn-default" onclick="selectBeentrustStockReferenceOpen()">引用受托已结算数据</button>
						</div>
					</div>
					<!-- /S 表体 -->
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/be-entrust-undo-settlement.js?v=${version}"></script>
