...
<html>
	...
	<div class="btn-toolbar " id="MenuTool"   data-code="FKD"  >
	</div>
		<!-------------------------------------主页面开始----------------------------------------->
			<div id="AUTH" data-code="FKD" class="none btn-group btnHundred" role="group" >
			  ...
			  <button type="button" class="btn btn-default addAudit" onclick="addPayment()">新增</button>
			  ...
			  <button type="button" class="btn btn-default" id="18" onclick="print(this.id)">打印</button>    
			  ...
			  <button type="button" class="btn btn-default" id="copy" onclick="copy();" disabled="disabled">复制</button>
				<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
						onclick="window.parent.openWorkBoxByMenutext('付款单-单据列表',  '/manager/inventory/fund/historyMain?billsType=18', true)">历史单据</button>

				<input type="hidden" value="18" id="payreceiptType"/>
			</div>
		...
		<div class="pageBillForm gridTop" id="collapseExample">
			...
			<div class="tablebox retailDetailTable">
				...
				<div class="boxmain">
					<p><span>单据总金额  <input type="text" disabled="disabled" id="amount"/></span>
					<span>核销折扣  <input type="text" id="hxDiscount" value="0.00" placeholder='至多12位数字' onkeyup='checkInput.checkNum(this,12);' /></span>
					<span>核销金额  <input type="text" disabled="disabled" id="nowAmount"/></span>
					<span>未核销金额  <input type="text" disabled="disabled" id="hasnotAmount" value="0.00"/></span></p>
					<br/>
					&nbsp;&nbsp;<button class="btn btn-default" id="fkdSave" onclick="hxSave();">保存</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="btn btn-default" onclick="hxEdit();" id="hxEditBtn">编辑</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button class="btn btn-default" id="fkdCancel" onclick="keyCancle();">一键核销</button>
				</div>
				<div class="grid-wrap" style="margin-top:10px">
					<table id="jqGrid_payment" class="zxsaastable">
					</table>
					<div id="jqGridPayment"></div>
				</div>
			</div>
			<!-------------------------------------表格结束----------------------------------------->
		<!-------------------------------------主页面结束----------------------------------------->
							...
							<div class="current change">
								<form id="filterSearchForm">
									...
									<div class="demoText form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="remark" value="" class="filterData form-control2" />
										</div>
									</div>
									<div class="demoText form-group">
	...
	<script src="${basePath}/js/erp/funds/payment-search.js?v=${version}" type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript">
		$(function(){
