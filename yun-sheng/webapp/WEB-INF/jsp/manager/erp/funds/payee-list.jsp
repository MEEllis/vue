...
<html>
	...
	<div class="btn-toolbar " id="MenuTool"   data-code="SKD"  >
	</div>
		<!-------------------------------------主页面开始----------------------------------------->
			<div id="AUTH" data-code="SKD" class="none btn-group btnHundred" role="group" >
			  ...
			  <button type="button" class="btn btn-default" id="19" onclick="print(this.id)">打印</button>      
			  ...
			  <button type="button" class="btn btn-default" id="copy" onclick="copy();" disabled="disabled">复制</button>
				<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
						onclick="window.parent.openWorkBoxByMenutext('收款单-单据列表',  '/manager/inventory/fund/historyMain?billsType=19', true)">历史单据</button>

				<input type="hidden" value="19" id="payreceiptType"/>
			</div>
		...
		<div class="pageBillForm gridTop" id="collapseExample">
			...
			<div class="tablebox retailDetailTable">
				...
				<div class="boxmain">
					...
					<span>核销折扣  <input type="text" id="hxDiscount" value="0" placeholder='至多12位数字' onkeyup='checkInput.checkNum(this,12);' /></span>
...
<!-------------------------------------模态框结束----------------------------------------->
	...
	<script type="text/javascript">
		$(function(){
			...
			//checkRole('#filterSearchForm');//过滤查询验证 暂时不做
