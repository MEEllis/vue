...
<html>
  ...
  <body>
	    ...
	    <div class=" gridTools">
	        <div class="col-md-12">
				<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="WTJSD" class="btn-group btnHundred">
	        		...
	        		<div class="row">
	        			<div class="col-md-3">
			        		<div class="form-horizontal" role="form" style="margin-top: 5px;"> 
								<div class="form-group">
								  <label class="col-sm-4 control-label">结算串号:</label>
	        			...
	        			<div class="col-md-3">
			        		<button type="button" class="btn btn-default" onclick="selectEntrustStockReferenceOpen()">引用委托未结算数据</button>
						</div>
					</div>
					<!-- /S 表体 -->
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/entrust-settlement.js?v=${version}"></script>
...
<!-- 委托库存引用 -->
<div class="modal fade" id="entrustStockReferenceModal" tabindex="-1" role="dialog"  aria-hidden="true">
   <div class="modal-dialog" style="width:930px;">
      <div class="modal-content">
         <div class="modal-body">
			<iframe name="entrustStockReferenceFrame" class="referenceFrame" id="entrustStockReferenceFrame" frameborder="0" style="width: 100%;" src="${basePath}/IcashEntrustStock/reference"></iframe>
         </div>
	  </div>
	</div>
</div>
