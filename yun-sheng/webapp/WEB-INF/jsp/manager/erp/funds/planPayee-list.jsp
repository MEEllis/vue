...
<html>
	...
	<div class="btn-toolbar " id="MenuTool" data-code="YSKD"  >
	</div>
		<!-------------------------------------主页面开始----------------------------------------->
			<div id="AUTH" data-code="YSKD" class="none btn-group btnHundred" role="group" >
			  ...
			  <button type="button" class="btn btn-default invalid" onclick="invalid();">红冲</button>
			   <button type="button" class="btn btn-default" id="21" onclick="print(this.id)">打印</button> 
			  ...
			  <button type="button" class="btn btn-default" onclick="javascript:parent.openWorkBoxByMenutext('往来结算','../manager/funds/settlement/initSettlement?urlParam=1');">预收冲应收</button>
				<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
						onclick="window.parent.openWorkBoxByMenutext('预收款单-单据列表',  '/manager/inventory/fund/historyMain?billsType=21', true)">历史单据</button>

				<input type="hidden" value="21" id="payreceiptType"/>
			</div>
