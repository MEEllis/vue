  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'detail'}">
		...
		<table class="table table-bordered">
			...
			<tbody>
				<c:forEach items="${bills.cashEntrustModpriList}" var="billsDetail" varStatus="status">
					<tr>
						<td style="font-size: 3mm;text-align:center;">${status.count}</td>
						<td style="font-size: 3mm;text-align:left;">${billsDetail.goodsName}</td>
						<td style="font-size: 3mm;text-align:center;">${billsDetail.noSeteNum}</td>
						<td style="font-size: 3mm;text-align:left;">${billsDetail.imei}</td>
						<td style="font-size: 3mm;text-align:right;"><fmt:formatNumber value="${billsDetail.ajustAmount/billsDetail.noSeteNum}" pattern="#,##0.00"/></td>
						<td style="font-size: 3mm;text-align:right;"><fmt:formatNumber value="${billsDetail.ajustAmount}" pattern="#,##0.00"/></td>
						<td style="font-size: 3mm;text-align:left;">${billsDetail.remark}</td>
					</tr>
				</c:forEach>		
				<tr>
					<td colspan="2" align="center" style="font-size: 4mm;">合计</td>
					<td style="font-size: 3mm;text-align: center;">${statistics:sumByField(bills.cashEntrustModpriList, 'noSeteNum')}</td>
					<td style="font-size: 3mm;"></td>
					<td style="font-size: 3mm;"></td>
					<td colspan="2" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashEntrustModpriList, 'ajustAmount')}" pattern="#,##0.00"/></td>
				</tr>
			</tbody>
		</table>
