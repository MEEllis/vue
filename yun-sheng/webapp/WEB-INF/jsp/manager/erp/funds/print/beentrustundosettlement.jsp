  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'detail'}">
		...
		<table class="table table-bordered">
			...
			<tbody>
				<c:forEach items="${bills.cashBeentrustDeldtlList}" var="billsDetail" varStatus="status">
					<tr>
				...
				<tr>
					...
					<td align="center" style="font-size: 3mm;">${statistics:sumByField(bills.cashBeentrustDeldtlList, 'disseteNum')}</td>
					<td style="font-size: 3mm;"></td>
					<td style="font-size: 3mm;"></td>
					<td colspan="2" align="center" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashBeentrustDeldtlList, 'disseteAmount')}" pattern="#,##0.00"/></td>
				</tr>
			</tbody>
		</table>
	...
	<c:if test="${tempKind == 'sum'}">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					<td colspan="2" align="center" style="font-size: 4mm;">合计</td>
					<td style="font-size: 3mm;" align="center">${statistics:sumByField(bills.cashBeentrustDeldtlList, 'disseteNum')}</td>
					<td style="font-size: 3mm;"></td>
					<td colspan="2" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashBeentrustDeldtlList, 'disseteAmount')}" pattern="#,##0.00"/></td>
				</tr>
			</tbody>
		</table>
