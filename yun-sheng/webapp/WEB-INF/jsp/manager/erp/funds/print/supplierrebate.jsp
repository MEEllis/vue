		...
		<tbody>
			<c:forEach items="${bills.cashRebateNumList}" var="billsDetail" varStatus="status">
				<tr>
					...
					<td style="font-size: 3mm;text-align:right;"><fmt:formatNumber value="${billsDetail.perAmount}" pattern="#,##0.00"/></td>
			...
			<tr>
				...
				<td colspan="2" style="font-size: 3mm;text-align: center;">
				   <fmt:formatNumber value="${statistics:sumByField(bills.cashRebateNumList, 'rebateAmount')}" pattern="#,##0.00"/>
				</td>
			</tr>
		</tbody>
	</table>
