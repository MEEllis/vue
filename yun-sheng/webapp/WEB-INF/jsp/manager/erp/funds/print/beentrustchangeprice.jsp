		...
		<table class="table table-bordered">
			<thead >
				<tr>
					...
					<th style="font-size: 3mm;font-weight: bold;text-align: center;">调价差额单价</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;">调价差额</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;">备注</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${bills.cashBeentrustModpriList}" var="billsDetail" varStatus="status">
					<tr>
				...
				<tr>
					...
					<td style="font-size: 3mm;text-align: center;">${statistics:sumByField(bills.cashBeentrustModpriList, 'noSeteNum')}</td>
					<td style="font-size: 3mm;"></td>
					<td style="font-size: 3mm;"></td>
					<td colspan="2" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashBeentrustModpriList, 'ajustAmount')}" pattern="#,##0.00"/></td>
				</tr>
			</tbody>
		</table>
