  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'detail'}">
		...
		<table class="table table-bordered">
			...
			<tbody>
				<c:forEach items="${bills.cashEntrustSetedtlList}" var="billsDetail" varStatus="status">
					<tr>
				...
				<tr>
					...
					<td style="font-size: 3mm;"></td>
					<td colspan="2" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashEntrustSetedtlList, 'seteAmount')}" pattern="#,##0.00"/></td>
				</tr>
			</tbody>
		</table>
