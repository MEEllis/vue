		...
		<table class="table table-bordered">
			<thead >
				<tr>
					...
					<th style="font-size: 3mm;font-weight: bold;text-align: center;">结算单价</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;">结算总额</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center;">备注</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${bills.cashBeentrustSetedtlList}" var="billsDetail" varStatus="status">
					<tr>
						<td style="font-size: 3mm;text-align:center;">${status.count}</td>
						<td style="font-size: 3mm;text-align:left;">${billsDetail.goodsName}</td>
						<td style="font-size: 3mm;text-align:center;">${billsDetail.seteNum}</td>
						<td style="font-size: 3mm;text-align:left;">${billsDetail.imei}</td>
						<td style="font-size: 3mm;text-align:right;"><fmt:formatNumber value="${billsDetail.setePrice}" pattern="#,##0.00"/></td>
						<td style="font-size: 3mm;text-align:right;"><fmt:formatNumber value="${billsDetail.seteAmount}" pattern="#,##0.00"/></td>
						<td style="font-size: 3mm;text-align:left;">${billsDetail.remark}</td>
					</tr>
				</c:forEach>		
				<tr>
					<td colspan="2" align="center" style="font-size: 4mm;">合计</td>
					<td style="font-size: 3mm;text-align: center;">${statistics:sumByField(bills.cashBeentrustSetedtlList, 'seteNum')}</td>
					<td style="font-size: 3mm;"></td>
					<td style="font-size: 3mm;"></td>
					<td colspan="2" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashBeentrustSetedtlList, 'seteAmount')}" pattern="#,##0.00"/></td>
				</tr>
			</tbody>
		</table>
	...
	<c:if test="${tempKind == 'sum'}">
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					<td colspan="2" align="center" style="font-size: 4mm;">合计</td>
					<td style="font-size: 3mm;text-align: center;">${statistics:sumByField(bills.cashEntrustSetedtlList, 'seteNum')}</td>
					<td style="font-size: 3mm;"></td>
					<td colspan="2" style="font-size: 3mm;text-align: center;"><fmt:formatNumber value="${statistics:sumByField(bills.cashBeentrustSetedtlList, 'seteAmount')}" pattern="#,##0.00"/> </td>
				</tr>
			</tbody>
