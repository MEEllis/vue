...
<html>
  ...
  <div class="btn-toolbar " id="MenuTool"  data-code="KHFLD"  >
  </div>
	<div >
		<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="KHFLD" class="none btn-group btnHundred">
					...
					<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
							onclick="window.parent.openWorkBoxByMenutext('客户返利单-单据列表',  '/manager/inventory/fund/historyMain?billsType=34', true)">历史单据</button>
  ...
  <script type="text/javascript" src="${basePath}/model/erp/model-stock-num.js?v=${version}"></script>
	...
	<script type="text/javascript" src="${basePath}/js/erp/funds/client-rebate.js?v=${version}"></script>
