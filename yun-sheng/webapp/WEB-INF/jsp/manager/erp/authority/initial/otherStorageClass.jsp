...
<html>
	...
	<body >
		<!-------------------------------------主页面开始----------------------------------------->
			<div class="well">
			<div id="AUTH" data-code="CRKFS" class="btn-group btnHundred" role="group" >
			<button type="button" class="btn btn-default" onclick="modalsaveOrUpdate(1)">新增</button>
			  ...
			  <button type="button" class="btn btn-default btnDeleteRow" onclick="disOrEnTotherstorageClass(2)">删除</button>	
			  <button type="button" class="btn btn-default qiyon" onclick="disOrEnTotherstorageClass(0)">启用</button>
			  <button type="button" class="btn btn-default jinyon" onclick="disOrEnTotherstorageClass(1)">禁用</button>
			...
			<form id="inquire_option">
				<div class="inputbox container-fluid clearfix">
					<div class="row">
						...
						<div class="Zpercent form-group">
							<span class="box_text2">出入库方式：</span>
							<label class="radio-inline">
							  <input type="radio" name="selFlag" class="radio_Class" id="inlineRadio1" value="0" checked="checked"> 入库
							</label>
							<label class="radio-inline">
							  <input type="radio" name="selFlag" class="radio_Class" id="inlineRadio2" value="1"> 出库
							</label>
						</div>
						<div class="Zpercent form-group">
							<label for="selStatus">显示禁用：
							...
							<div class="current change">
								<form id="saveOrUpdateForm">
									...
									<div class="">
										...
										<label for="">出入库方式:</label>
										<input type="radio" name="flag" id="flag0" value="0" style="width:2.5rem"> 
										<label class="radio-inline" for="flag0" style="width:4rem;margin-right:0px">入库</label>
										
									    <input type="radio" name="flag" id="flag1" value="1"  style="width:2.5rem"> 
										<label class="radio-inline" for="flag1" style="width:4rem;margin-right:0px;margin-left: -1.7em;">出库</label>
										<span class="msg"></span>
									</div>
									<div class="">
										<label for="">编码:</label>
	...
	<script src="${basePath}/js/erp/authority/initial/otherStorageClass.js?v=${version}" type="text/javascript" charset="utf-8"></script>
