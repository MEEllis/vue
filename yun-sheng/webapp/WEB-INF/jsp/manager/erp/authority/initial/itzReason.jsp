...
<html>
	...
	<body >
		<!-------------------------------------主页面开始----------------------------------------->
			<div class="well">
			<div id="AUTH" data-code="CBTZYY" class="btn-group btnHundred" role="group" >
			<button type="button" class="btn btn-default" onclick="modalsaveOrUpdate(1)">新增</button>
			  ...
			  <button type="button" class="btn btn-default btnDeleteRow" onclick="delItzReason(2)">删除</button>	
	...
	<script src="${basePath}/js/erp/authority/initial/itzReason.js?v=${version}" type="text/javascript" charset="utf-8"></script>
