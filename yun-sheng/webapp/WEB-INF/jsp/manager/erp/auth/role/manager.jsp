...
<html>
    ...
    .left { border-right: 1px solid #cfcfcf;}
    .details{width:85%;}
    .details div.right{
        height: 54px;
        padding-top: 15px;
	...
	<body >
		<!-------------------------------------主页面开始----------------------------------------->
		   <div id="AUTH" data-code="JSGL" class="btn-group btnHundred" role="group" >
			...
			<div class="" style="width=100%;height:auto;overflow:hidden;border: 1px solid #cfcfcf;border-radius: 3px;">
				...
				<div class="details">
					<div class="right" style="border-bottom: 1px solid #cfcfcf;">
						...
						<label for="data_oper" style="font-size: 16px;font-weight: normal;margin-left: 7rem;">数据操作授权&nbsp;&nbsp;<input type="checkbox" class="shou-checkbox" id="data_oper" /></label>
					--></div>
					<!--表格-->
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="" style="height:100%;overflow: hidden; border: 1px solid #cfcfcf;border-radius:3px">
							<div class="left" style="height:100%">
								<div class="left-s" style="font-size:1.4em">授权菜单</div>
								<div class="left_tree" style="height:100%">
							...
							<div class="details">
								<div class="right">
									...
									<span>角色名称:<input type="text" id="roleName" maxLength=32 style="width:148px;height:28px;border:1px solid #cfcfcf"/></span>
									<!--<label for="shou-checkbox-add_id" style="font-size: 16px;font-weight: normal;margin-left: 7rem;">数据操作授权&nbsp;&nbsp;<input type="checkbox" class="shou-checkbox-add" id="shou-checkbox-add_id"/></label>
								--></div>
								<!--表格-->
								<div class="jqGrid_wrap" style="width:100%;min-height:335px" id="add_jqwrap">
					...
					<div class="modal-footer">
					   	<button type="button" class="btn btn-success save_add" >保存</button>
						...
						<div class="" style="height:auto;overflow: hidden; border: 1px solid #cfcfcf;border-radius:3px">
							...
							<div class="details">
								<div class="right">
									...
									<label for="shou-checkbox-update-id" style="font-size: 16px;font-weight: normal;margin-left: 7rem;">数据操作授权&nbsp;&nbsp;<input type="checkbox" class="shou-checkbox-update" id="shou-checkbox-update-id"/></label>
								</div>
								<!--表格-->
			...
			<div class="modal-dialog model-dialog2">
				<div class="modal-content" >
					...
					<div class="modal-body" id="model-body">
						<div class="showTab" style="height:auto">
							<div class="current change">
								<div class="collapse in" id="collapseExample" style="width:100%;min-width:708px!important;height:50px;min-height:50px;">
						 			 <div class="">
	...
	<script src="${basePath}/js/erp/auth/roleManager.js?v=2.19.1" type="text/javascript" charset="utf-8"></script>
