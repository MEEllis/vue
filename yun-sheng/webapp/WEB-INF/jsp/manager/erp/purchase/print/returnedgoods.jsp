...
<%@page import="com.zx.soft.model.jxc.IbillsMain"%>
  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'noimei'}">
		...
		<table class="table table-bordered" border-color="black">
			...
			<tbody>
				<c:forEach items="${bills.outstrorageNumList}" var="billsDetail" varStatus="status">
					<tr style="padding: 0;">
				...
				<tr style="padding: 0;">
					...
					<td style="font-size: 3mm;text-align: center; padding:0;">${statistics:sumByField(bills.outstrorageNumList, 'goodsNumber')}</td>
					<td style="font-size: 3mm; padding:0;"></td>
					<td style="font-size: 3mm;text-align: right; padding:0;">${statistics:sumByField(bills.outstrorageNumList, 'amount')}</td>
					<td colspan="2" style="font-size: 3mm;text-align:center; padding:0;">${statistics:sumByField(bills.outstrorageNumList, 'discountedAmount')}</td>
				</tr>
			</tbody>
		</table>
		
		<!-- 收付款明细 -->
		<c:if test="${!bills.payreceiptDetailList.isEmpty()}">
		<table class="table table-bordered" border-color="black">
			<thead>
				<tr style="padding: 0;">
				<th style="font-size: 3mm;font-weight: bold;width: 13mm;text-align: center; padding:0;">序号</th>
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			<%--<div class="form-group" style="width: 40mm;float: left;">--%>
			  ...
			  <%--<fmt:formatNumber value="${bills.billsDiscount}" pattern="#,##0.00"/>--%>
			  <%--</span>--%>
			<%--</div>--%>
			<div class="form-group" style="width: 40mm;float: left;">
			  <label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
			  ...
			  <fmt:formatNumber value="${bills.billsAmount}" pattern="#,##0.00"/>
			  </span>
			</div>
			<div class="form-group" style="width: 40mm;float: left;">
			  <label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;width: 20mm;">
			  <fmt:formatNumber value="${bills.billsAmount - statistics:sumByField2(bills.payreceiptDetailList, 'payreceiptAmout', 'Double') - bills.billsDiscount}" pattern="#,##0.00"/>
			  </span>
			</div>
