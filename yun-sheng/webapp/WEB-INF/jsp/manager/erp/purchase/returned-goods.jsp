...
<html>
  ...
  <body>
	    ...
	    <div class=" gridTools">
	        <div class="col-md-12">
				<div class="" style="padding: 0px;margin-top: 10px;">
 				<div id="AUTH" data-code="CGTHD" class="btn-group btnHundred">
					...
					<button type="button" class="btn btn-default btn-yindao-btn" style="float:right;"
							onclick="window.parent.openWorkBoxByMenutext('采购退货单单据列表',  '/manager/inventory/purchase/historyMain?billsType=4', true)">历史单据</button>
		        ...
		        <form class="form-horizontal" role="form" style="margin-top: 5px;" id="middleForm"> 
				  ...
				  <div class="formBtn">
					<div class="form-group">
					  ...
					  <div class="col-sm-8">
					    <input type="text" class="form-control billsDiscount" name="billsDiscount" value="0"/>
					  </div>
					</div>
				  </div>
				  <div class="formBtn">
				  ...
				  <div class="formBtn">
					<div class="form-group">
					  <label class="col-sm-4 control-label">未收金额:</label>
					  <div class="col-sm-8">
					    <input type="text" class="form-control" name="weiFuAmount" disabled="disabled" value="0.00">
					  </div>
					</div>
				  </div>
				</form>
	...
	<script type="text/javascript" src="${basePath}/js/erp/purchase/returned-goods.js?v=${version}"></script>
   ...
   <div class="modal-dialog" style="width:80%;" id="inputStorageImeiModal_body">
      <div class="modal-content">
         ...
         <div class="modal-body" style="margin-bottom: 20px;">
			...
			<div style="padding-left: 0px;padding-right: 0px;float: left;min-height: 180px;min-width: 170px;margin-left: 13px;" id="inputStorageImeiModal_info">
