...
<html>
 ...
 <body >
			...
			<form id="inquire_option">
				<div class="inputbox container-fluid clearfix">
					<div class="row">
						...
						<div class="col-xs-2">
							<span class="box_text">返利类型：</span><span class="box_input"><select type="form-control" name="resourceTypeId" id="" value="" placeholder="" class="form-control" /></select></span>
						</div>
					...
					<div class="row">
						...
						<div class="col-xs-2">
							<span class="box_text">经手人：</span><span class="box_input"><select class="form-control" name="resourceTypeId" data-src="" data-default="" value=""></select></span>
						</div>
						<div class="col-xs-2">
						...
						<div class="col-xs-2">
							<span class="box_text">返利部门：</span><span class="box_input"><select class="form-control" name="resourceTypeId" data-src="" data-default="" value=""></select></span>
						</div>
						<div class="col-xs-2">
	...
	<script src="../../js/pagejs/threeThModel/channelRebate.js?v=${version}" type="text/javascript" charset="utf-8"></script>
