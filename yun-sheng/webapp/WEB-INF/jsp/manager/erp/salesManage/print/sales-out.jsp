...
<html>
  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'noimei'}">
		...
		<table class="table-bordered" style="font-size: 4mm;width: 188mm;text-align: center;margin-bottom: 5px;" border-color="black">
			<thead>
				<tr style="padding: 0;">
					...
					<th style="text-align: center;padding: 0;">赠品</th>
			...
			<tbody style="font-size: 3mm;">
				<c:forEach items="${bills.outStorageNumList}" var="billsDetail" varStatus="status">
					<tr style="padding: 0;">
						...
						<td style="padding: 0;">${billsDetail.giftFlag==0?'':'√'}</td>
				 ...
				 <tr style="font-size: 4mm; padding:0;">
					<td colspan="4" align="center" style="padding: 0;">合计</td>
		...
		<table class="table-bordered" style="width: 188mm;" bordercolor="black">
			<thead>
				<tr style="padding: 0;">
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			...
			<div class="form-group" style="width: 40mm;float: left;">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;width: 20mm;">
			   <fmt:formatNumber value="${statistics:sumByField(bills.outStorageNumList, 'taxAmount')-bills.billsDiscount}" pattern="#,##0.00#"/>
			  </span>
			</div>
			<div class="form-group" style="width: 40mm;float: left;">
			  <label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;width: 20mm;">
			  <fmt:formatNumber value="${statistics:sumByField(bills.outStorageNumList, 'taxAmount')-bills.billsDiscount-bills.prepaymentAmount}" pattern="#,##0.00#"/>
			  </span>
			</div>
			<div class="form-group" style="width: 40mm;float: left;">
				<label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
