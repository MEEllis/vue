...
<html>
  ...
  <body style="padding: 10px;">
	...
	<c:if test="${tempKind == 'noimei'}">
	    ...
	    <div style="font-size: 3mm;">
			...
			<div class="form-group" style="width: 62mm;float: left;margin-bottom: 1mm; ">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;">
			  ${contactUnitAmountVo.shouldReceiptBalance}
			  </span>
			</div>
			<div class="form-group" style="width: 62mm;float: left;margin-bottom: 1mm;">
			  <label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 17mm;text-align: right;">
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			...
			<div class="form-group" style="width: 40mm;float: left;">
			  ...
			  <fmt:formatNumber value="${statistics:sumByField(bills.salesInstrorageNumList, 'taxAmount')-bills.billsDiscount}" pattern="#,##0.00#"/>
			  </span>
			</div>
			<div class="form-group" style="width: 40mm;float: left;">
			  <label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;width: 20mm;">
			  <fmt:formatNumber value="${statistics:sumByField(bills.salesInstrorageNumList, 'taxAmount')-bills.billsDiscount-bills.prepaymentAmount}" pattern="#,##0.00#"/>
			  </span>
			</div>
			<div class="form-group" style="width: 40mm;float: left;">
				<label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
	...
	<c:if test="${tempKind == 'showimei'}">
		...
		<table class="table-bordered" style="width: 188mm;font-size: 4mm;text-align: center;margin-bottom: 5px;" border-color="black">
			...
			<tbody style="font-size: 3mm;">
				<c:forEach items="${bills.salesInstrorageNumList}" var="billsDetail" varStatus="status">
					...
					<tr>
						<td colspan="7" style="font-size: 3mm;text-align:left;height: auto;">
				 ...
				 <tr style="font-size: 4mm; padding: 0;">
					<td colspan="3" align="center" style="font-size: 4mm; padding: 0;">合计</td>
					<td style="font-size: 3mm;text-align: center;padding: 0;">${statistics:sumByField(bills.salesInstrorageNumList, 'goodsNumber')}</td>
					<%--<td style="font-size: 3mm;padding: 0;"></td>--%>
					<td style="font-size: 3mm;text-align: right;padding: 0;"><fmt:formatNumber value="${statistics:sumByField(bills.salesInstrorageNumList, 'amount')}" pattern="#,##0.00#"/></td>
					<td colspan="2" style="font-size: 3mm;text-align: right;padding: 0;"><fmt:formatNumber value="${statistics:sumByField(bills.salesInstrorageNumList, 'discountedAmount')}" pattern="#,##0.00#"/></td>
					<%--<td style="padding: 0;"></td>--%>
				</tr>		
			</tbody>
		</table>
		...
		<!-- 收付款明细 -->
		<c:if test="${!bills.salesBillsAccount.isEmpty()&& bills.prepaymentAmount!=null}">
		<table class="table-bordered" style="width: 188mm;">
			<thead>
				<tr>
				<th style="font-size: 3mm;font-weight: bold;width: 13mm;text-align: center;">序号</th>
				<th style="font-size: 3mm;font-weight: bold;text-align: center;">收款类别</th>
				<th style="font-size: 3mm;font-weight: bold;text-align: center;">账户名称</th>
				<th style="font-size: 3mm;font-weight: bold;text-align: center;">收款金额</th>
				</tr>
			</thead>
			<tbody>
			    <% int indexx = 1; %>
				<c:forEach items="${bills.salesBillsAccount}" var="payreceiptDetail" varStatus="status">
					<c:if test="${payreceiptDetail.payreceiptAmout != '' && payreceiptDetail.payreceiptAmout != null}">
					<tr>
	    ...
	    <div id="formBottom" style="font-size: 3mm;">
			...
			<div class="form-group" style="width: 40mm;float: left;">
			  ...
			  <span class="col-sm-8" style="padding-left: 3px;padding-right: 0px;width: 20mm;">
			  <fmt:formatNumber value="${statistics:sumByField(bills.salesInstrorageNumList, 'taxAmount')}" pattern="#,##0.00"/>
			  </span>
			</div>
			<div class="form-group" style="width: 40mm;float: left;">
			  <label class="col-sm-4 control-label" style="padding-left: 1px;padding-right: 0px;width: 15mm;">
