...
<html>
	...
	<body >
		...
		<div class="collapse in" id="collapseExample">
			...
			<div class="tablebox retailDetailTable">
				...
				<div class="grid-wrap" style="margin-top:10px" id="tableDiv">
	...
	<script src="${basePath}/js/pagejs/threeThModel/channelChangeUpdate.js?v=${version}" type="text/javascript" charset="utf-8"></script>
