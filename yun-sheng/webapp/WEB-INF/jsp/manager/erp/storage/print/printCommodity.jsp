		...
		<table class="table table-bordered" bordercolor="black">
			<thead >
				<tr style="padding: 0;">
					...
					<th style="font-size: 3mm;font-weight: bold;text-align: center; padding:0">移出数量</th>
					<th style="font-size: 3mm;font-weight: bold;text-align: center; padding:0">商品备注</th>
				</tr>
			</thead>
			<tbody>
				<c:set var="sum" value="0"></c:set>
				<c:forEach items="${bills.goodsTransferList}" var="detail" varStatus="status">
					...
					<tr style="padding: 0;">
						<td colspan="4" style="font-size: 3mm;text-align:left;height: auto; padding:0">
