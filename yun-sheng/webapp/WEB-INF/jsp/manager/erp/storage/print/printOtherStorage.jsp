  ...
  <body style="padding: 10px;">
	...
	<c:if test="${printType == 'imeiDetail'}">
		...
		<table class="table table-bordered" bordercolor="black">
			...
			<tbody>
				...
				<c:forEach items="${bills.instroNumList}" var="detail" varStatus="status">
					<c:set var="sumNum" value="${sumNum+detail.goodsNumber}"></c:set>
					...
					<tr style="padding: 0;">
						...
						<td style="font-size: 3mm;text-align:center; padding:0">${detail.price}</td>
						<td style="font-size: 3mm;text-align:center; padding:0">${detail.amount}</td>
				...
				<tr style="padding: 0">
					...
					<td style="font-size: 3mm; padding: 0;" align="center">${sumNum }</td>
					<td></td>
					<td colspan="2" align="center" style="font-size: 3mm; padding: 0;">${sumPri }</td>
				</tr>
			</tbody>
		</table>
	...
	<c:if test="${printType == 'numberDetail'}">
		...
		<table class="table table-bordered" bordercolor="black">
			...
			<tbody>
				<c:set var="sumNum2" value="0"></c:set>
				<c:set var="sumPri2" value="0"></c:set>
				<c:forEach items="${bills.instroNumList}" var="detail" varStatus="status">
					<c:set var="sumNum2" value="${sumNum2+detail.goodsNumber}"></c:set>
				...
				<tr style="padding: 0">
					<td colspan="3" align="center" style="font-size: 4mm; padding: 0;">合计</td>
					<td style="font-size: 3mm; padding: 0;" align="center">${sumNum2 }</td>
					<td></td>
					<td colspan="2" align="center" style="font-size: 3mm; padding: 0;">${sumPri2 }</td>
				</tr>
			</tbody>
		</table>
