...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${basePath}/css/Storage/changeAllot.css?v=${version}"/>
	...
	<body>
 		<div class="well">
 		<div id="AUTH" data-code="BJDBFHD" class="btn-group btnHundred">
				  ...
				  <button type="button" class="btn" onclick="changeAllotGzHc(1)">发货</button>
				  ...
				  <button type="button" class="btn" data-eventname="printbtn">复制</button>			  			  			  			  
				...
				<div class="inputbox container-fluid clearfix">
					<div class="row">
						<div class="form-group Zpercent">
							<span class="box_text2">单据编号：</span><div class="col-sm-8">
								<div class="input-group"><input type="text" id="billsCode" name="billsCode" class="form-control2" disabled  /></div></div>
						</div>
						<div class="form-group Zpercent">
							<span class="box_text2">调出部门：</span>
						    <div class="col-sm-8">
								<div class="input-group">
					             <input type="text" value="" class="form-control2 depSearch" id="outDepartmentName" name="outDepartmentName" onkeydown="departmentDel('outDepartmentName')">
						...
						<div class="form-group Zpercent">
							<span for="datetimepickerStart" class="box_text2">单据日期：</span><div class="col-sm-8">
								<div class="input-group"><input type="text" class="form-control2 dateKJ" id="billsDateString" name="billsDateString" placeholder="年-月-日"  /></div></div>
						</div>
					...
					<div class="row">
						<div class="form-group Zpercent">
							...
							<div class="col-sm-8">
								<div class="input-group">
							     <select class="managers a" id="managersUid" name="managersUid" disabled="disabled">
						...
						<div class="form-group Zpercent">
							...
							<div class="col-sm-8">
								<div class="input-group">
					             <input type="text" class="form-control2 depSearch" id="inDepartmentName" name="inDepartmentName" onkeydown="departmentDel('inDepartmentName')">
							      <span class="input-group-btn">
						...
						<div class="form-group Zpercent">
							<span class="box_text2">单备注：</span><div class="col-sm-8">
								<div class="input-group"><input type="text" name="remark" id="remark" placeholder="" class="form-control2 dateKJ" /></div></div>
						</div>
					</div>
				</div>
				<div class="rightMap">
			...
			<div class="modal-dialog modalSmall">
				<div class="modal-content ">
				  ...
				  <div class="modal-body" style="text-align: center;font-size: 16px;">				  	
				  	...
				  	<div class="modal-footer">
						<button type="button" class="btn btn-warning" data-dismiss="modal">关闭提示</button>
				   </div>		
				  </div>					
				</div>
			</div><!-- /.modal -->
						...
						<div class="showTab">
							<div class="inputModal">
								<form id="filterForm">
									...
									<div class="inputTab">
										<span>调出部门：</span>
										<span><input type="text" id="filterOutName" onkeydown="departmentDel('filterOutName')"/></span>
				  			     		<span class="colspan loadspan glyphicon glyphicon-plus depFilter" onclick="yesAuthority('filterOutName')"></span>
									</div>
									<div class="inputTab">
										<span>单据编号：</span>
									...
									<div class="inputTab">
										<span>调入部门：</span>
										<span><input type="text" id="filterInName" onkeydown="departmentDel('filterInName')"/></span>
				  						<span class="colspan loadspan glyphicon glyphicon-plus depFilter" onclick="noAuthority('filterInName')"></span>
									</div>
									<div class="inputTab">
										<span>单&nbsp;&nbsp;备&nbsp;注：</span>
									...
									<div class="inputTab">
										...
										<span><input type="text" id="selGoodsName"/></span>
				  						<span class="goodsName glyphicon glyphicon-plus colspan" onclick="showGoodsImport()"></span>
									</div>
									<div class="inputTab">
										<span>串&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</span>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" onclick="changeAllotGzHc(2)">
							确定
						</button>
					</div>
				</div><!-- /.modal-content -->
			...
			<!-------------------------------------表格开始----------------------------------------->
				  ...
				  <div class="">
				     ...
				     <span class="box_input input-group">
				     	<input type="text" id="otherOutstroNumIdStr" value="" name="otherOutstroNumIdStr" onpropertychange="imeiMate();" oninput="imeiMate();" onkeydown="EnterPressOtherImei()"  placeholder="串号录入,可右匹配" class="form-control2 font100 input-none" />
		...
		<div class="collapse in" id="collapseExample">
				<div class="inputbox foot1175 clearfix">
						<div class="Zpercent2 ">
	...
	<script src="${basePath}/js/erp/storage/changeAllot.js?v=${version}" type="text/javascript" charset="utf-8"></script>
	<script src="${basePath}/js/erp/storage/changeAllotCC.js?v=${version}" type="text/javascript" charset="utf-8"></script>
