...
<html>
	...
	<body >
 			 <div class="well">
 			 <!-- 按钮开始------- --------- -->
 			 <div id="AUTH" data-code="QTRKD" class="btn-group btnHundred">
					...
					<button type="button" class="btn btn-default" onclick="onclickNewBills()">新增</button>
			    	<button type="button" class="btn btn-default" onclick="onClickExecute()">保存</button>	
			   		<button type="button" class="btn btn-default" onclick="onClickDelete()">删除</button>	
			   		<button type="button" class="btn btn-default" onclick="otherInStorageGzHc(1)">过账</button>	
				...
				<div class="inputbox container-fluid clearfix">
					...
					<div class="row">
						...
						<div class="form-group Zpercent">
							...
							<div class="col-sm-8">
								<div class="input-group">
								<select class="sel form-control2" disabled="disabled" id="storageId" name="storageId" onchange="selectStorage()">
									<option value="" selected>请选择部门</option>
								</select>
								</div></div>
						</div>
						<div class="form-group Zpercent">
							<span class="box_text2">入库方式：</span>
							<div class="col-sm-8">
								<div class="input-group">
				...
				<div class="modal-content ">
				  ...
				  <div class="modal-body">
					  	<div class="inputModal clearfix">
					  		...
					  		<div class="inputTab" style="clear:both;float:none;height:initial;">
						...
						<div class="clearfix">
							 ...
							 <div class="jqGrid_wrap"><table id="jqGrid_tranNumber" class="zxsaastable"></table></div>
						</div>
					...
					<div class="modal-body" id="model-body">
						<div class="showTab">
							<div class="inputModal">
									...
									<div class="inputTab">
										<span>单据编号：</span>
										<span><input type="text" name="selBillsCode" id="selBillsCode" class="filterData" /></span>
									</div>
									<div class="inputTab">
										<span>结束日期：</span>
									...
									<div class="inputTab">
										<span>单&nbsp;&nbsp;备&nbsp;&nbsp;注：</span>
										<span><input type="text" name="selRemark" id="selRemark" /></span>
									</div>
									<div class="inputTab">
										<span>商品名称：</span>
					...
					<div class="modal-body">
						<div class="container">
							<div class="left">
								...
								<div class="left_tree">
									<input type="hidden" class="storage_tree_ids" />
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" onclick="otherInStorageGzHc(2)">
							确定
						</button>
					</div>
				</div><!-- /.modal-content -->
	...
	<script src="${basePath}/js/erp/storage/otherStorage.js?v=${version}" type="text/javascript" charset="utf-8"></script>
	<script src="${basePath}/js/erp/storage/otherStorageCC.js?v=${version}" type="text/javascript" charset="utf-8"></script>
