...
<html>
	...
	<body >
		...
		<div class="well">
			...
			<div id="AUTH" data-code="JRGL" class="btn-group btnHundred">
			    	...
			    	<button type="button" class="btn btn-default saveData" onclick="onClickExecute()">保存</button>	
			   		...
			   		<button type="button" class="btn btn-default" onclick="borrowSaleGzHc(1)">过账</button>	
		...
		<div class="tablebox retailDetailTable container-fluid" style="margin-left:20px;">
				<p><button class="font-table import" onclick="importBorrowLend()">引入借入未归回单据</button></p>
				<div class="row">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" onclick="borrowSaleGzHc(2)">
							确定
						</button>
					</div>
				</div><!-- /.modal-content -->
	...
	<script src="${basePath}/js/erp/storage/borrowSaleDetail.js?v=${version}" type="text/javascript" charset="utf-8"></script>
