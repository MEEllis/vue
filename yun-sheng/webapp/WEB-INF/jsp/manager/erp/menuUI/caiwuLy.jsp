...
<html>
    ...
    <body>
		<div class="wrap">
			<div class="picLeft">
				<div class="first">
					<div class="tubiao">
						<a onclick="javascript:parent.openWorkBoxByMenutext('填制凭证','/manager/cw/test/voucher');" class="aTubiao">
					...
					<div class="tubiao">
						<a onclick="javascript:parent.openWorkBoxByMenutext('生成凭证','/manager/cw/generateVoucher');" class="aTubiao">
				...
				<div class="five">
					<div class="tubiao">
						<a onclick="javascript:parent.openWorkBoxByMenutext('损益结转','/manager/cw/profitAndLossTransfer');" class="aTubiao">
					...
					<div class="tubiao">
						<a onclick="javascript:parent.openWorkBoxByMenutext('记账','/manager/cw/bookkeeping');" class="aTubiao">
				...
				<div class="seven">
					<div class="tubiao">
						<a onclick="javascript:parent.openWorkBoxByMenutext('月末结算','/manager/cw/settleAccounts');" class="aTubiao">
	...
	<script>
		...
		$(function(){
			getData('${basePath}/json/erp/menuUI/caiwu.json');
		});
		//function setCover(){
        //     var picLeftWidth = document.body.offsetWidth;
         //    alert(picLeftWidth);
