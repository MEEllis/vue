...
import SecretPriceGroupSearch from '../components/ApiPrice/js/SecretPriceGroupSearch';
...
const mapStateToProps = (state) => ({
  ...
  setSecretPriceAndPriceGroupResult: state.secretPriceSetting.setSecretPriceAndPriceGroupResult,
