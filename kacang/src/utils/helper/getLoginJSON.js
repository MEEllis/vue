...
export function getLoginJSON(url, options) {
    ...
    let reqConfig = Object.assign({}, config, defaults, options);
    ...
    .then((res) => {
        ...
        switch (res.Status) {
            ...
            //     localStorage.setItem('km:loginFlow', JSON.stringify({data:null,isLoading:false}) );
